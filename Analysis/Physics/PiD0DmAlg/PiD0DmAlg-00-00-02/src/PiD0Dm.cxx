        ...
        if (m_sample_types[i] == "signal") {
            ...
            if (nt_signal) m_tuple_signal = nt_signal;
                ...
                if (m_tuple_signal) {
                    ...
                    status = m_tuple_signal->addItem("n_combination",                    m_n_combination_signal);
        ...
        if (m_sample_types[i] == "side1_low") {
            ...
            if (nt_side1_low) m_tuple_side1_low = nt_side1_low;
                ...
                if (m_tuple_side1_low) {
                    ...
                    status = m_tuple_side1_low->addItem("n_combination",                    m_n_combination_side1_low);
        ...
        if (m_sample_types[i] == "side1_up") {
            ...
            if (nt_side1_up) m_tuple_side1_up = nt_side1_up;
                ...
                if (m_tuple_side1_up) {
                    ...
                    status = m_tuple_side1_up->addItem("n_combination",                    m_n_combination_side1_up);
        ...
        if (m_sample_types[i] == "side2_low") {
            ...
            if (nt_side2_low) m_tuple_side2_low = nt_side2_low;
                ...
                if (m_tuple_side2_low) {
                    ...
                    status = m_tuple_side2_low->addItem("n_combination",                    m_n_combination_side2_low);
        ...
        if (m_sample_types[i] == "side2_up") {
            ...
            if (nt_side2_up) m_tuple_side2_up = nt_side2_up;
                ...
                if (m_tuple_side2_up) {
                    ...
                    status = m_tuple_side2_up->addItem("n_combination",                    m_n_combination_side2_up);
        ...
        if (m_sample_types[i] == "side3_low") {
            ...
            if (nt_side3_low) m_tuple_side3_low = nt_side3_low;
                ...
                if (m_tuple_side3_low) {
                    ...
                    status = m_tuple_side3_low->addItem("n_combination",                    m_n_combination_side3_low);
        ...
        if (m_sample_types[i] == "side3_up") {
            ...
            if (nt_side3_up) m_tuple_side3_up = nt_side3_up;
                ...
                if (m_tuple_side3_up) {
                    ...
                    status = m_tuple_side3_up->addItem("n_combination",                    m_n_combination_side3_up);
        ...
        if (m_sample_types[i] == "side4_low") {
            ...
            if (nt_side4_low) m_tuple_side4_low = nt_side4_low;
                ...
                if (m_tuple_side4_low) {
                    ...
                    status = m_tuple_side4_low->addItem("n_combination",                    m_n_combination_side4_low);
        ...
        if (m_sample_types[i] == "side4_up") {
            ...
            if (nt_side4_up) m_tuple_side4_up = nt_side4_up;
                ...
                if (m_tuple_side4_up) {
                    ...
                    status = m_tuple_side4_up->addItem("n_combination",                    m_n_combination_side4_up);
    ...
    for (int mm = 0; mm < m_sample_types.size(); mm++) {
        ...
        for (int modeA = 0; modeA != m_modes_D0.size(); modeA++ ) {
            for (int modeB = 0; modeB != m_modes_Dm.size(); modeB++) {
                ...
                ppim.clear();
                bool dtagflag = false;
                dtagflag = dtagTool.findDDTag(m_modes_D0[modeA], m_modes_Dm[modeB], MassD0Cand, MassDmCand, "inv");
                int n_combination = dtagTool.findDDCombination();
                ...
                bool oksq = kmfit->Fit();
                if (!oksq) continue;
                if (m_debug) std::cout <<  "runNo: " << runNo << ", evtNo: " << evtNo << ", modeA = " << m_modes_D0[modeA] << ", modeB= " << m_modes_Dm[modeB] << ", Index: " << dtagTool.findDDIndex() << std::endl;
                ...
                if (chisq < CHISQ) {
                    combination_fill = n_combination;
                    CHISQ = chisq;
                    besKD0p4 = kD0p4;
                    besKDmp4 = kDmp4;
                    besKpipp4 = kpipp4;
        ...
        HepLorentzVector kpipp4 = kmfit->pfit(tracks1.size() + showers1.size() + tracks2.size() + showers2.size());
        if (m_sample_types[mm] == "signal") {
            m_chisq_6c_signal = chisq;
	        m_p4_D0_6c_signal[0] = kD0p4.px();
            m_p4_D0_6c_signal[1] = kD0p4.py();
            m_p4_D0_6c_signal[2] = kD0p4.pz();
            m_p4_D0_6c_signal[3] = kD0p4.e();
            m_p4_Dm_6c_signal[0] = kDmp4.px();
            m_p4_Dm_6c_signal[1] = kDmp4.py();
            m_p4_Dm_6c_signal[2] = kDmp4.pz();
            m_p4_Dm_6c_signal[3] = kDmp4.e();
            m_p4_pip_6c_signal[0] = kpipp4.px();
            m_p4_pip_6c_signal[1] = kpipp4.py();
            m_p4_pip_6c_signal[2] = kpipp4.pz();
            m_p4_pip_6c_signal[3] = kpipp4.e();
            Ncut41++;
            // std::cout << "runNo: " << runNo << ", evtNo: " << evtNo << ", modeA = " << m_D0_mode_signal << " modeB= " << m_Dm_mode_signal << std::endl;
            recordVariables(m_sample_types[mm]);
            dtagTool.clear();
        }
        if (m_sample_types[mm] == "side1_low") {
            m_chisq_6c_side1_low = chisq;
	        m_p4_D0_6c_side1_low[0] = kD0p4.px();
            m_p4_D0_6c_side1_low[1] = kD0p4.py();
            m_p4_D0_6c_side1_low[2] = kD0p4.pz();
            m_p4_D0_6c_side1_low[3] = kD0p4.e();
            m_p4_Dm_6c_side1_low[0] = kDmp4.px();
            m_p4_Dm_6c_side1_low[1] = kDmp4.py();
            m_p4_Dm_6c_side1_low[2] = kDmp4.pz();
            m_p4_Dm_6c_side1_low[3] = kDmp4.e();
            m_p4_pip_6c_side1_low[0] = kpipp4.px();
            m_p4_pip_6c_side1_low[1] = kpipp4.py();
            m_p4_pip_6c_side1_low[2] = kpipp4.pz();
            m_p4_pip_6c_side1_low[3] = kpipp4.e();
            Ncut41++;
            recordVariables(m_sample_types[mm]);
            dtagTool.clear();
        }
        if (m_sample_types[mm] == "side1_up") {
            m_chisq_6c_side1_up = chisq;
	        m_p4_D0_6c_side1_up[0] = kD0p4.px();
            m_p4_D0_6c_side1_up[1] = kD0p4.py();
            m_p4_D0_6c_side1_up[2] = kD0p4.pz();
            m_p4_D0_6c_side1_up[3] = kD0p4.e();
            m_p4_Dm_6c_side1_up[0] = kDmp4.px();
            m_p4_Dm_6c_side1_up[1] = kDmp4.py();
            m_p4_Dm_6c_side1_up[2] = kDmp4.pz();
            m_p4_Dm_6c_side1_up[3] = kDmp4.e();
            m_p4_pip_6c_side1_up[0] = kpipp4.px();
            m_p4_pip_6c_side1_up[1] = kpipp4.py();
            m_p4_pip_6c_side1_up[2] = kpipp4.pz();
            m_p4_pip_6c_side1_up[3] = kpipp4.e();
            Ncut41++;
            recordVariables(m_sample_types[mm]);
            dtagTool.clear();
        }
        if (m_sample_types[mm] == "side2_low") {
            m_chisq_6c_side2_low = chisq;
	        m_p4_D0_6c_side2_low[0] = kD0p4.px();
            m_p4_D0_6c_side2_low[1] = kD0p4.py();
            m_p4_D0_6c_side2_low[2] = kD0p4.pz();
            m_p4_D0_6c_side2_low[3] = kD0p4.e();
            m_p4_Dm_6c_side2_low[0] = kDmp4.px();
            m_p4_Dm_6c_side2_low[1] = kDmp4.py();
            m_p4_Dm_6c_side2_low[2] = kDmp4.pz();
            m_p4_Dm_6c_side2_low[3] = kDmp4.e();
            m_p4_pip_6c_side2_low[0] = kpipp4.px();
            m_p4_pip_6c_side2_low[1] = kpipp4.py();
            m_p4_pip_6c_side2_low[2] = kpipp4.pz();
            m_p4_pip_6c_side2_low[3] = kpipp4.e();
            Ncut41++;
            recordVariables(m_sample_types[mm]);
            dtagTool.clear();
        }
        if (m_sample_types[mm] == "side2_up") {
            m_chisq_6c_side2_up = chisq;
	        m_p4_D0_6c_side2_up[0] = kD0p4.px();
            m_p4_D0_6c_side2_up[1] = kD0p4.py();
            m_p4_D0_6c_side2_up[2] = kD0p4.pz();
            m_p4_D0_6c_side2_up[3] = kD0p4.e();
            m_p4_Dm_6c_side2_up[0] = kDmp4.px();
            m_p4_Dm_6c_side2_up[1] = kDmp4.py();
            m_p4_Dm_6c_side2_up[2] = kDmp4.pz();
            m_p4_Dm_6c_side2_up[3] = kDmp4.e();
            m_p4_pip_6c_side2_up[0] = kpipp4.px();
            m_p4_pip_6c_side2_up[1] = kpipp4.py();
            m_p4_pip_6c_side2_up[2] = kpipp4.pz();
            m_p4_pip_6c_side2_up[3] = kpipp4.e();
            Ncut41++;
            recordVariables(m_sample_types[mm]);
            dtagTool.clear();
        }
        ...
        if (m_sample_types[mm] == "side3_low") {
            m_chisq_6c_side3_low = chisq;
	        m_p4_D0_6c_side3_low[0] = kD0p4.px();
            m_p4_D0_6c_side3_low[1] = kD0p4.py();
            m_p4_D0_6c_side3_low[2] = kD0p4.pz();
            m_p4_D0_6c_side3_low[3] = kD0p4.e();
            m_p4_Dm_6c_side3_low[0] = kDmp4.px();
            m_p4_Dm_6c_side3_low[1] = kDmp4.py();
            m_p4_Dm_6c_side3_low[2] = kDmp4.pz();
            m_p4_Dm_6c_side3_low[3] = kDmp4.e();
            m_p4_pip_6c_side3_low[0] = kpipp4.px();
            m_p4_pip_6c_side3_low[1] = kpipp4.py();
            m_p4_pip_6c_side3_low[2] = kpipp4.pz();
            m_p4_pip_6c_side3_low[3] = kpipp4.e();
            Ncut41++;
            recordVariables(m_sample_types[mm]);
            dtagTool.clear();
        }
        if (m_sample_types[mm] == "side3_up") {
            m_chisq_6c_side3_up = chisq;
	        m_p4_D0_6c_side3_up[0] = kD0p4.px();
            m_p4_D0_6c_side3_up[1] = kD0p4.py();
            m_p4_D0_6c_side3_up[2] = kD0p4.pz();
            m_p4_D0_6c_side3_up[3] = kD0p4.e();
            m_p4_Dm_6c_side3_up[0] = kDmp4.px();
            m_p4_Dm_6c_side3_up[1] = kDmp4.py();
            m_p4_Dm_6c_side3_up[2] = kDmp4.pz();
            m_p4_Dm_6c_side3_up[3] = kDmp4.e();
            m_p4_pip_6c_side3_up[0] = kpipp4.px();
            m_p4_pip_6c_side3_up[1] = kpipp4.py();
            m_p4_pip_6c_side3_up[2] = kpipp4.pz();
            m_p4_pip_6c_side3_up[3] = kpipp4.e();
            Ncut41++;
            recordVariables(m_sample_types[mm]);
            dtagTool.clear();
        }
        if (m_sample_types[mm] == "side4_low") {
            m_chisq_6c_side4_low = chisq;
	        m_p4_D0_6c_side4_low[0] = kD0p4.px();
            m_p4_D0_6c_side4_low[1] = kD0p4.py();
            m_p4_D0_6c_side4_low[2] = kD0p4.pz();
            m_p4_D0_6c_side4_low[3] = kD0p4.e();
            m_p4_Dm_6c_side4_low[0] = kDmp4.px();
            m_p4_Dm_6c_side4_low[1] = kDmp4.py();
            m_p4_Dm_6c_side4_low[2] = kDmp4.pz();
            m_p4_Dm_6c_side4_low[3] = kDmp4.e();
            m_p4_pip_6c_side4_low[0] = kpipp4.px();
            m_p4_pip_6c_side4_low[1] = kpipp4.py();
            m_p4_pip_6c_side4_low[2] = kpipp4.pz();
            m_p4_pip_6c_side4_low[3] = kpipp4.e();
            Ncut41++;
            recordVariables(m_sample_types[mm]);
            dtagTool.clear();
        }
        if (m_sample_types[mm] == "side4_up") {
            m_chisq_6c_side4_up = chisq;
	        m_p4_D0_6c_side4_up[0] = kD0p4.px();
            m_p4_D0_6c_side4_up[1] = kD0p4.py();
            m_p4_D0_6c_side4_up[2] = kD0p4.pz();
            m_p4_D0_6c_side4_up[3] = kD0p4.e();
            m_p4_Dm_6c_side4_up[0] = kDmp4.px();
            m_p4_Dm_6c_side4_up[1] = kDmp4.py();
            m_p4_Dm_6c_side4_up[2] = kDmp4.pz();
            m_p4_Dm_6c_side4_up[3] = kDmp4.e();
            m_p4_pip_6c_side4_up[0] = kpipp4.px();
            m_p4_pip_6c_side4_up[1] = kpipp4.py();
            m_p4_pip_6c_side4_up[2] = kpipp4.pz();
            m_p4_pip_6c_side4_up[3] = kpipp4.e();
            Ncut41++;
            recordVariables(m_sample_types[mm]);
            dtagTool.clear();
        }
...
void PiD0Dm::recordVariables(std::string sample_type) {
    if (sample_type == "signal") {
        ...
        m_n_combination_signal = combination_fill;
    ...
    if (sample_type == "side1_low") {
        ...
        m_n_combination_side1_low = combination_fill;
        // save all McTruth info
    ...
    if (sample_type == "side1_up") {
        ...
        m_n_combination_side1_up = combination_fill;
        // save all McTruth info
    ...
    if (sample_type == "side2_low") {
        ...
        m_n_combination_side2_low = combination_fill;
        // save all McTruth info
    ...
    if (sample_type == "side2_up") {
        ...
        m_n_combination_side2_up = combination_fill;
        // save all McTruth info
    ...
    if (sample_type == "side3_low") {
        ...
        m_n_combination_side3_low = combination_fill;
        // save all McTruth info
    ...
    if (sample_type == "side3_up") {
        ...
        m_n_combination_side3_up = combination_fill;
        // save all McTruth info
    ...
    if (sample_type == "side4_low") {
        ...
        m_n_combination_side4_low = combination_fill;
        // save all McTruth info
    ...
    if (sample_type == "side4_up") {
        ...
        m_n_combination_side4_up = combination_fill;
        // save all McTruth info
