        ...
        if (m_sample_types[i] == "signal") {
            ...
            if (nt_signal) m_tuple_signal = nt_signal;
                ...
                if (m_tuple_signal) {
                    ...
                    status = m_tuple_signal->addItem("D0_mBC",                           m_D0_mBC_signal);
                    ...
                    status = m_tuple_signal->addItem("D0_BE",                            m_D0_be_signal);
                    status = m_tuple_signal->addItem("D0_deltaE",                        m_D0_deltae_signal);
                    ...
                    status = m_tuple_signal->addItem("Dm_mBC",                           m_Dm_mBC_signal);
                    ...
                    status = m_tuple_signal->addItem("Dm_BE",                            m_Dm_be_signal);
                    status = m_tuple_signal->addItem("Dm_deltaE",                        m_Dm_deltae_signal);
        ...
        if (m_sample_types[i] == "side1_low") {
            ...
            if (nt_side1_low) m_tuple_side1_low = nt_side1_low;
                ...
                if (m_tuple_side1_low) {
                    ...
                    status = m_tuple_side1_low->addItem("D0_mBC",                           m_D0_mBC_side1_low);
                    ...
                    status = m_tuple_side1_low->addItem("D0_BE",                            m_D0_be_side1_low);
                    status = m_tuple_side1_low->addItem("D0_deltaE",                        m_D0_deltae_side1_low);
                    ...
                    status = m_tuple_side1_low->addItem("Dm_mBC",                           m_Dm_mBC_side1_low);
                    ...
                    status = m_tuple_side1_low->addItem("Dm_BE",                            m_Dm_be_side1_low);
                    status = m_tuple_side1_low->addItem("Dm_deltaE",                        m_Dm_deltae_side1_low);
        ...
        if (m_sample_types[i] == "side1_up") {
            ...
            if (nt_side1_up) m_tuple_side1_up = nt_side1_up;
                ...
                if (m_tuple_side1_up) {
                    ...
                    status = m_tuple_side1_up->addItem("D0_mBC",                           m_D0_mBC_side1_up);
                    ...
                    status = m_tuple_side1_up->addItem("D0_BE",                            m_D0_be_side1_up);
                    status = m_tuple_side1_up->addItem("D0_deltaE",                        m_D0_deltae_side1_up);
                    ...
                    status = m_tuple_side1_up->addItem("Dm_mBC",                           m_Dm_mBC_side1_up);
                    ...
                    status = m_tuple_side1_up->addItem("Dm_BE",                            m_Dm_be_side1_up);
                    status = m_tuple_side1_up->addItem("Dm_deltaE",                        m_Dm_deltae_side1_up);
        ...
        if (m_sample_types[i] == "side2_low") {
            ...
            if (nt_side2_low) m_tuple_side2_low = nt_side2_low;
                ...
                if (m_tuple_side2_low) {
                    ...
                    status = m_tuple_side2_low->addItem("D0_mBC",                           m_D0_mBC_side2_low);
                    ...
                    status = m_tuple_side2_low->addItem("D0_BE",                            m_D0_be_side2_low);
                    status = m_tuple_side2_low->addItem("D0_deltaE",                        m_D0_deltae_side2_low);
                    ...
                    status = m_tuple_side2_low->addItem("Dm_mBC",                           m_Dm_mBC_side2_low);
                    ...
                    status = m_tuple_side2_low->addItem("Dm_BE",                            m_Dm_be_side2_low);
                    status = m_tuple_side2_low->addItem("Dm_deltaE",                        m_Dm_deltae_side2_low);
        ...
        if (m_sample_types[i] == "side2_up") {
            ...
            if (nt_side2_up) m_tuple_side2_up = nt_side2_up;
                ...
                if (m_tuple_side2_up) {
                    ...
                    status = m_tuple_side2_up->addItem("D0_mBC",                           m_D0_mBC_side2_up);
                    ...
                    status = m_tuple_side2_up->addItem("D0_BE",                            m_D0_be_side2_up);
                    status = m_tuple_side2_up->addItem("D0_deltaE",                        m_D0_deltae_side2_up);
                    ...
                    status = m_tuple_side2_up->addItem("Dm_mBC",                           m_Dm_mBC_side2_up);
                    ...
                    status = m_tuple_side2_up->addItem("Dm_BE",                            m_Dm_be_side2_up);
                    status = m_tuple_side2_up->addItem("Dm_deltaE",                        m_Dm_deltae_side2_up);
        ...
        if (m_sample_types[i] == "side3_low") {
            ...
            if (nt_side3_low) m_tuple_side3_low = nt_side3_low;
                ...
                if (m_tuple_side3_low) {
                    ...
                    status = m_tuple_side3_low->addItem("D0_mBC",                           m_D0_mBC_side3_low);
                    ...
                    status = m_tuple_side3_low->addItem("D0_BE",                            m_D0_be_side3_low);
                    status = m_tuple_side3_low->addItem("D0_deltaE",                        m_D0_deltae_side3_low);
                    ...
                    status = m_tuple_side3_low->addItem("Dm_mBC",                           m_Dm_mBC_side3_low);
                    ...
                    status = m_tuple_side3_low->addItem("Dm_BE",                            m_Dm_be_side3_low);
                    status = m_tuple_side3_low->addItem("Dm_deltaE",                        m_Dm_deltae_side3_low);
        ...
        if (m_sample_types[i] == "side3_up") {
            ...
            if (nt_side3_up) m_tuple_side3_up = nt_side3_up;
                ...
                if (m_tuple_side3_up) {
                    ...
                    status = m_tuple_side3_up->addItem("D0_mBC",                           m_D0_mBC_side3_up);
                    ...
                    status = m_tuple_side3_up->addItem("D0_BE",                            m_D0_be_side3_up);
                    status = m_tuple_side3_up->addItem("D0_deltaE",                        m_D0_deltae_side3_up);
                    ...
                    status = m_tuple_side3_up->addItem("Dm_mBC",                           m_Dm_mBC_side3_up);
                    ...
                    status = m_tuple_side3_up->addItem("Dm_BE",                            m_Dm_be_side3_up);
                    status = m_tuple_side3_up->addItem("Dm_deltaE",                        m_Dm_deltae_side3_up);
        ...
        if (m_sample_types[i] == "side4_low") {
            ...
            if (nt_side4_low) m_tuple_side4_low = nt_side4_low;
                ...
                if (m_tuple_side4_low) {
                    ...
                    status = m_tuple_side4_low->addItem("D0_mBC",                           m_D0_mBC_side4_low);
                    ...
                    status = m_tuple_side4_low->addItem("D0_BE",                            m_D0_be_side4_low);
                    status = m_tuple_side4_low->addItem("D0_deltaE",                        m_D0_deltae_side4_low);
                    ...
                    status = m_tuple_side4_low->addItem("Dm_mBC",                           m_Dm_mBC_side4_low);
                    ...
                    status = m_tuple_side4_low->addItem("Dm_BE",                            m_Dm_be_side4_low);
                    status = m_tuple_side4_low->addItem("Dm_deltaE",                        m_Dm_deltae_side4_low);
        ...
        if (m_sample_types[i] == "side4_up") {
            ...
            if (nt_side4_up) m_tuple_side4_up = nt_side4_up;
                ...
                if (m_tuple_side4_up) {
                    ...
                    status = m_tuple_side4_up->addItem("D0_mBC",                           m_D0_mBC_side4_up);
                    ...
                    status = m_tuple_side4_up->addItem("D0_BE",                            m_D0_be_side4_up);
                    status = m_tuple_side4_up->addItem("D0_deltaE",                        m_D0_deltae_side4_up);
                    ...
                    status = m_tuple_side4_up->addItem("Dm_mBC",                           m_Dm_mBC_side4_up);
                    ...
                    status = m_tuple_side4_up->addItem("Dm_BE",                            m_Dm_be_side4_up);
                    status = m_tuple_side4_up->addItem("Dm_deltaE",                        m_Dm_deltae_side4_up);
        ...
        for (int modeA = 0; modeA != m_modes_D0.size(); modeA++ ) {
            for (int modeB = 0; modeB != m_modes_Dm.size(); modeB++) {
                ...
                for (int itag = 0; itag < vtag1.size(); itag++) {
                    ...
                    if (m_sample_types[mm] == "signal") m_n_D0trks_signal = 0;
                    if (m_sample_types[mm] == "side1_low") m_n_D0trks_side1_low = 0;
                    if (m_sample_types[mm] == "side1_up") m_n_D0trks_side1_up = 0;
                    if (m_sample_types[mm] == "side2_low") m_n_D0trks_side2_low = 0;
                    if (m_sample_types[mm] == "side2_up") m_n_D0trks_side2_up = 0;
                    if (m_sample_types[mm] == "side3_low") m_n_D0trks_side3_low = 0;
                    if (m_sample_types[mm] == "side3_up") m_n_D0trks_side3_up = 0;
                    if (m_sample_types[mm] == "side4_low") m_n_D0trks_side4_low = 0;
                    if (m_sample_types[mm] == "side4_up") m_n_D0trks_side4_up = 0;
                    HepLorentzVector pK;
                    ...
                    for (int trk1 = 0; trk1 < Tracks1.size(); trk1++) {
                        ...
                        if (dtagTool.isKaon(Tracks1[trk1])) {
                            ...
                            if (m_sample_types[mm] == "signal") {
                                for (int k = 0; k < 4; k++) m_rawp4_D0trks_signal[m_n_D0trks_signal][k] = KalTrk->p4(mka)[k];
                                m_rawp4_D0trks_signal[m_n_D0trks_signal][4] = KalTrk->charge();
                                m_rawp4_D0trks_signal[m_n_D0trks_signal][5] = 3;
                                pK.setPx(KalTrk->p4(mka)[0]);
                                pK.setPy(KalTrk->p4(mka)[1]);
                                pK.setPz(KalTrk->p4(mka)[2]);
                                pK.setE(KalTrk->p4(mka)[3]);
                                if (runNo < 0) m_rawp4_D0trks_signal[m_n_D0trks_signal][6] = MatchMC(pK, "D0_tag");
                                else m_rawp4_D0trks_signal[m_n_D0trks_signal][6] = -999;
                                if (runNo < 0) m_rawp4_D0trks_signal[m_n_D0trks_signal][7] = MatchMC(pK, "Dm_tag");
                                else m_rawp4_D0trks_signal[m_n_D0trks_signal][7] = -999;
                                ...
                                m_vtx_D0trks_signal[m_n_D0trks_signal][0] = fabs(vecipa[0]);
                                m_vtx_D0trks_signal[m_n_D0trks_signal][1] = fabs(vecipa[3]);
                                m_vtx_D0trks_signal[m_n_D0trks_signal][2] = cos(KalTrk->theta());
                            }
                            if (m_sample_types[mm] == "side1_low") {
                                for (int k = 0; k < 4; k++) m_rawp4_D0trks_side1_low[m_n_D0trks_side1_low][k] = KalTrk->p4(mka)[k];
                                m_rawp4_D0trks_side1_low[m_n_D0trks_side1_low][4] = KalTrk->charge();
                                m_rawp4_D0trks_side1_low[m_n_D0trks_side1_low][5] = 3;
                                pK.setPx(KalTrk->p4(mka)[0]);
                                pK.setPy(KalTrk->p4(mka)[1]);
                                pK.setPz(KalTrk->p4(mka)[2]);
                                pK.setE(KalTrk->p4(mka)[3]);
                                if (runNo < 0) m_rawp4_D0trks_side1_low[m_n_D0trks_side1_low][6] = MatchMC(pK, "D0_tag");
                                else m_rawp4_D0trks_side1_low[m_n_D0trks_side1_low][6] = -999;
                                if (runNo < 0) m_rawp4_D0trks_side1_low[m_n_D0trks_side1_low][7] = MatchMC(pK, "Dm_tag");
                                else m_rawp4_D0trks_side1_low[m_n_D0trks_side1_low][7] = -999;
                                HepVector a = KalTrk->getZHelixK();
                                HepSymMatrix Ea = KalTrk->getZErrorK();
                                HepPoint3D point0(0., 0., 0.);
                                HepPoint3D IP(xorigin[0], xorigin[1], xorigin[2]);
                                ...
                                helixip.pivot(IP);
                                HepVector vecipa = helixip.a();
                                m_vtx_D0trks_side1_low[m_n_D0trks_side1_low][0] = fabs(vecipa[0]);
                                m_vtx_D0trks_side1_low[m_n_D0trks_side1_low][1] = fabs(vecipa[3]);
                                m_vtx_D0trks_side1_low[m_n_D0trks_side1_low][2] = cos(KalTrk->theta());
                            }
                            if (m_sample_types[mm] == "side1_up") {
                                for (int k = 0; k < 4; k++) m_rawp4_D0trks_side1_up[m_n_D0trks_side1_up][k] = KalTrk->p4(mka)[k];
                                m_rawp4_D0trks_side1_up[m_n_D0trks_side1_up][4] = KalTrk->charge();
                                m_rawp4_D0trks_side1_up[m_n_D0trks_side1_up][5] = 3;
                                pK.setPx(KalTrk->p4(mka)[0]);
                                pK.setPy(KalTrk->p4(mka)[1]);
                                pK.setPz(KalTrk->p4(mka)[2]);
                                pK.setE(KalTrk->p4(mka)[3]);
                                if (runNo < 0) m_rawp4_D0trks_side1_up[m_n_D0trks_side1_up][6] = MatchMC(pK, "D0_tag");
                                else m_rawp4_D0trks_side1_up[m_n_D0trks_side1_up][6] = -999;
                                if (runNo < 0) m_rawp4_D0trks_side1_up[m_n_D0trks_side1_up][7] = MatchMC(pK, "Dm_tag");
                                else m_rawp4_D0trks_side1_up[m_n_D0trks_side1_up][7] = -999;
                                HepVector a = KalTrk->getZHelixK();
                                HepSymMatrix Ea = KalTrk->getZErrorK();
                                HepPoint3D point0(0., 0., 0.);
                                HepPoint3D IP(xorigin[0], xorigin[1], xorigin[2]);
                                ...
                                helixip.pivot(IP);
                                HepVector vecipa = helixip.a();
                                m_vtx_D0trks_side1_up[m_n_D0trks_side1_up][0] = fabs(vecipa[0]);
                                m_vtx_D0trks_side1_up[m_n_D0trks_side1_up][1] = fabs(vecipa[3]);
                                m_vtx_D0trks_side1_up[m_n_D0trks_side1_up][2] = cos(KalTrk->theta());
                            }
                            if (m_sample_types[mm] == "side2_low") {
                                for (int k = 0; k < 4; k++) m_rawp4_D0trks_side2_low[m_n_D0trks_side2_low][k] = KalTrk->p4(mka)[k];
                                m_rawp4_D0trks_side2_low[m_n_D0trks_side2_low][4] = KalTrk->charge();
                                m_rawp4_D0trks_side2_low[m_n_D0trks_side2_low][5] = 3;
                                pK.setPx(KalTrk->p4(mka)[0]);
                                pK.setPy(KalTrk->p4(mka)[1]);
                                pK.setPz(KalTrk->p4(mka)[2]);
                                pK.setE(KalTrk->p4(mka)[3]);
                                if (runNo < 0) m_rawp4_D0trks_side2_low[m_n_D0trks_side2_low][6] = MatchMC(pK, "D0_tag");
                                else m_rawp4_D0trks_side2_low[m_n_D0trks_side2_low][6] = -999;
                                if (runNo < 0) m_rawp4_D0trks_side2_low[m_n_D0trks_side2_low][7] = MatchMC(pK, "Dm_tag");
                                else m_rawp4_D0trks_side2_low[m_n_D0trks_side2_low][7] = -999;
                                HepVector a = KalTrk->getZHelixK();
                                HepSymMatrix Ea = KalTrk->getZErrorK();
                                HepPoint3D point0(0., 0., 0.);
                                HepPoint3D IP(xorigin[0], xorigin[1], xorigin[2]);
                                ...
                                helixip.pivot(IP);
                                HepVector vecipa = helixip.a();
                                m_vtx_D0trks_side2_low[m_n_D0trks_side2_low][0] = fabs(vecipa[0]);
                                m_vtx_D0trks_side2_low[m_n_D0trks_side2_low][1] = fabs(vecipa[3]);
                                m_vtx_D0trks_side2_low[m_n_D0trks_side2_low][2] = cos(KalTrk->theta());
                            }
                            if (m_sample_types[mm] == "side2_up") {
                                for (int k = 0; k < 4; k++) m_rawp4_D0trks_side2_up[m_n_D0trks_side2_up][k] = KalTrk->p4(mka)[k];
                                m_rawp4_D0trks_side2_up[m_n_D0trks_side2_up][4] = KalTrk->charge();
                                m_rawp4_D0trks_side2_up[m_n_D0trks_side2_up][5] = 3;
                                pK.setPx(KalTrk->p4(mka)[0]);
                                pK.setPy(KalTrk->p4(mka)[1]);
                                pK.setPz(KalTrk->p4(mka)[2]);
                                pK.setE(KalTrk->p4(mka)[3]);
                                if (runNo < 0) m_rawp4_D0trks_side2_up[m_n_D0trks_side2_up][6] = MatchMC(pK, "D0_tag");
                                else m_rawp4_D0trks_side2_up[m_n_D0trks_side2_up][6] = -999;
                                if (runNo < 0) m_rawp4_D0trks_side2_up[m_n_D0trks_side2_up][7] = MatchMC(pK, "Dm_tag");
                                else m_rawp4_D0trks_side2_up[m_n_D0trks_side2_up][7] = -999;
                                HepVector a = KalTrk->getZHelixK();
                                HepSymMatrix Ea = KalTrk->getZErrorK();
                                HepPoint3D point0(0., 0., 0.);
                                HepPoint3D IP(xorigin[0], xorigin[1], xorigin[2]);
                                ...
                                helixip.pivot(IP);
                                HepVector vecipa = helixip.a();
                                m_vtx_D0trks_side2_up[m_n_D0trks_side2_up][0] = fabs(vecipa[0]);
                                m_vtx_D0trks_side2_up[m_n_D0trks_side2_up][1] = fabs(vecipa[3]);
                                m_vtx_D0trks_side2_up[m_n_D0trks_side2_up][2] = cos(KalTrk->theta());
                            }
                            if (m_sample_types[mm] == "side3_low") {
                                for (int k = 0; k < 4; k++) m_rawp4_D0trks_side3_low[m_n_D0trks_side3_low][k] = KalTrk->p4(mka)[k];
                                m_rawp4_D0trks_side3_low[m_n_D0trks_side3_low][4] = KalTrk->charge();
                                m_rawp4_D0trks_side3_low[m_n_D0trks_side3_low][5] = 3;
                                pK.setPx(KalTrk->p4(mka)[0]);
                                pK.setPy(KalTrk->p4(mka)[1]);
                                pK.setPz(KalTrk->p4(mka)[2]);
                                pK.setE(KalTrk->p4(mka)[3]);
                                if (runNo < 0) m_rawp4_D0trks_side3_low[m_n_D0trks_side3_low][6] = MatchMC(pK, "D0_tag");
                                else m_rawp4_D0trks_side3_low[m_n_D0trks_side3_low][6] = -999;
                                if (runNo < 0) m_rawp4_D0trks_side3_low[m_n_D0trks_side3_low][7] = MatchMC(pK, "Dm_tag");
                                else m_rawp4_D0trks_side3_low[m_n_D0trks_side3_low][7] = -999;
                                HepVector a = KalTrk->getZHelixK();
                                HepSymMatrix Ea = KalTrk->getZErrorK();
                                HepPoint3D point0(0., 0., 0.);
                                HepPoint3D IP(xorigin[0], xorigin[1], xorigin[2]);
                                ...
                                helixip.pivot(IP);
                                HepVector vecipa = helixip.a();
                                m_vtx_D0trks_side3_low[m_n_D0trks_side3_low][0] = fabs(vecipa[0]);
                                m_vtx_D0trks_side3_low[m_n_D0trks_side3_low][1] = fabs(vecipa[3]);
                                m_vtx_D0trks_side3_low[m_n_D0trks_side3_low][2] = cos(KalTrk->theta());
                            }
                            if (m_sample_types[mm] == "side3_up") {
                                for (int k = 0; k < 4; k++) m_rawp4_D0trks_side3_up[m_n_D0trks_side3_up][k] = KalTrk->p4(mka)[k];
                                m_rawp4_D0trks_side3_up[m_n_D0trks_side3_up][4] = KalTrk->charge();
                                m_rawp4_D0trks_side3_up[m_n_D0trks_side3_up][5] = 3;
                                pK.setPx(KalTrk->p4(mka)[0]);
                                pK.setPy(KalTrk->p4(mka)[1]);
                                pK.setPz(KalTrk->p4(mka)[2]);
                                pK.setE(KalTrk->p4(mka)[3]);
                                if (runNo < 0) m_rawp4_D0trks_side3_up[m_n_D0trks_side3_up][6] = MatchMC(pK, "D0_tag");
                                else m_rawp4_D0trks_side3_up[m_n_D0trks_side3_up][6] = -999;
                                if (runNo < 0) m_rawp4_D0trks_side3_up[m_n_D0trks_side3_up][7] = MatchMC(pK, "Dm_tag");
                                else m_rawp4_D0trks_side3_up[m_n_D0trks_side3_up][7] = -999;
                                HepVector a = KalTrk->getZHelixK();
                                HepSymMatrix Ea = KalTrk->getZErrorK();
                                HepPoint3D point0(0., 0., 0.);
                                HepPoint3D IP(xorigin[0], xorigin[1], xorigin[2]);
                                ...
                                helixip.pivot(IP);
                                HepVector vecipa = helixip.a();
                                m_vtx_D0trks_side3_up[m_n_D0trks_side3_up][0] = fabs(vecipa[0]);
                                m_vtx_D0trks_side3_up[m_n_D0trks_side3_up][1] = fabs(vecipa[3]);
                                m_vtx_D0trks_side3_up[m_n_D0trks_side3_up][2] = cos(KalTrk->theta());
                            }
                            if (m_sample_types[mm] == "side4_low") {
                                for (int k = 0; k < 4; k++) m_rawp4_D0trks_side4_low[m_n_D0trks_side4_low][k] = KalTrk->p4(mka)[k];
                                m_rawp4_D0trks_side4_low[m_n_D0trks_side4_low][4] = KalTrk->charge();
                                m_rawp4_D0trks_side4_low[m_n_D0trks_side4_low][5] = 3;
                                pK.setPx(KalTrk->p4(mka)[0]);
                                pK.setPy(KalTrk->p4(mka)[1]);
                                pK.setPz(KalTrk->p4(mka)[2]);
                                pK.setE(KalTrk->p4(mka)[3]);
                                if (runNo < 0) m_rawp4_D0trks_side4_low[m_n_D0trks_side4_low][6] = MatchMC(pK, "D0_tag");
                                else m_rawp4_D0trks_side4_low[m_n_D0trks_side4_low][6] = -999;
                                if (runNo < 0) m_rawp4_D0trks_side4_low[m_n_D0trks_side4_low][7] = MatchMC(pK, "Dm_tag");
                                else m_rawp4_D0trks_side4_low[m_n_D0trks_side4_low][7] = -999;
                                HepVector a = KalTrk->getZHelixK();
                                HepSymMatrix Ea = KalTrk->getZErrorK();
                                HepPoint3D point0(0., 0., 0.);
                                HepPoint3D IP(xorigin[0], xorigin[1], xorigin[2]);
                                ...
                                helixip.pivot(IP);
                                HepVector vecipa = helixip.a();
                                m_vtx_D0trks_side4_low[m_n_D0trks_side4_low][0] = fabs(vecipa[0]);
                                m_vtx_D0trks_side4_low[m_n_D0trks_side4_low][1] = fabs(vecipa[3]);
                                m_vtx_D0trks_side4_low[m_n_D0trks_side4_low][2] = cos(KalTrk->theta());
                            }
                            if (m_sample_types[mm] == "side4_up") {
                                for (int k = 0; k < 4; k++) m_rawp4_D0trks_side4_up[m_n_D0trks_side4_up][k] = KalTrk->p4(mka)[k];
                                m_rawp4_D0trks_side4_up[m_n_D0trks_side4_up][4] = KalTrk->charge();
                                m_rawp4_D0trks_side4_up[m_n_D0trks_side4_up][5] = 3;
                                pK.setPx(KalTrk->p4(mka)[0]);
                                pK.setPy(KalTrk->p4(mka)[1]);
                                pK.setPz(KalTrk->p4(mka)[2]);
                                pK.setE(KalTrk->p4(mka)[3]);
                                if (runNo < 0) m_rawp4_D0trks_side4_up[m_n_D0trks_side4_up][6] = MatchMC(pK, "D0_tag");
                                else m_rawp4_D0trks_side4_up[m_n_D0trks_side4_up][6] = -999;
                                if (runNo < 0) m_rawp4_D0trks_side4_up[m_n_D0trks_side4_up][7] = MatchMC(pK, "Dm_tag");
                                else m_rawp4_D0trks_side4_up[m_n_D0trks_side4_up][7] = -999;
                                HepVector a = KalTrk->getZHelixK();
                                HepSymMatrix Ea = KalTrk->getZErrorK();
                                HepPoint3D point0(0., 0., 0.);
                                HepPoint3D IP(xorigin[0], xorigin[1], xorigin[2]);
                                ...
                                helixip.pivot(IP);
                                HepVector vecipa = helixip.a();
                                m_vtx_D0trks_side4_up[m_n_D0trks_side4_up][0] = fabs(vecipa[0]);
                                m_vtx_D0trks_side4_up[m_n_D0trks_side4_up][1] = fabs(vecipa[3]);
                                m_vtx_D0trks_side4_up[m_n_D0trks_side4_up][2] = cos(KalTrk->theta());
                            }
                        }
                        else {
                            ...
                            if (m_sample_types[mm] == "signal") {
                                for (int k = 0; k < 4; k++) m_rawp4_D0trks_signal[m_n_D0trks_signal][k] = KalTrk->p4(mpi)[k];
                                m_rawp4_D0trks_signal[m_n_D0trks_signal][4] = KalTrk->charge();
                                m_rawp4_D0trks_signal[m_n_D0trks_signal][5] = 2;
                                ppi.setPx(KalTrk->p4(mpi)[0]);
                                ppi.setPy(KalTrk->p4(mpi)[1]);
                                ppi.setPz(KalTrk->p4(mpi)[2]);
                                ppi.setE(KalTrk->p4(mpi)[3]);
                                if (runNo < 0) m_rawp4_D0trks_signal[m_n_D0trks_signal][6] = MatchMC(ppi, "D0_tag");
                                else m_rawp4_D0trks_signal[m_n_D0trks_signal][6] = -999;
                                if (runNo < 0) m_rawp4_D0trks_signal[m_n_D0trks_signal][7] = MatchMC(ppi, "Dm_tag");
                                else m_rawp4_D0trks_signal[m_n_D0trks_signal][7] = -999;
                                HepVector a = KalTrk->getZHelixK();
                                HepSymMatrix Ea = KalTrk->getZErrorK();
                                HepPoint3D point0(0., 0., 0.);
                            ...
                            if (m_sample_types[mm] == "side1_low") {
                                for (int k = 0; k < 4; k++) m_rawp4_D0trks_side1_low[m_n_D0trks_side1_low][k] = KalTrk->p4(mpi)[k];
                                m_rawp4_D0trks_side1_low[m_n_D0trks_side1_low][4] = KalTrk->charge();
                                m_rawp4_D0trks_side1_low[m_n_D0trks_side1_low][5] = 2;
                                ppi.setPx(KalTrk->p4(mpi)[0]);
                                ppi.setPy(KalTrk->p4(mpi)[1]);
                                ppi.setPz(KalTrk->p4(mpi)[2]);
                                ppi.setE(KalTrk->p4(mpi)[3]);
                                if (runNo < 0) m_rawp4_D0trks_side1_low[m_n_D0trks_side1_low][6] = MatchMC(ppi, "D0_tag");
                                else m_rawp4_D0trks_side1_low[m_n_D0trks_side1_low][6] = -999;
                                if (runNo < 0) m_rawp4_D0trks_side1_low[m_n_D0trks_side1_low][7] = MatchMC(ppi, "Dm_tag");
                                else m_rawp4_D0trks_side1_low[m_n_D0trks_side1_low][7] = -999;
                                HepVector a = KalTrk->getZHelixK();
                                HepSymMatrix Ea = KalTrk->getZErrorK();
                                HepPoint3D point0(0., 0., 0.);
                            ...
                            if (m_sample_types[mm] == "side1_up") {
                                for (int k = 0; k < 4; k++) m_rawp4_D0trks_side1_up[m_n_D0trks_side1_up][k] = KalTrk->p4(mpi)[k];
                                m_rawp4_D0trks_side1_up[m_n_D0trks_side1_up][4] = KalTrk->charge();
                                m_rawp4_D0trks_side1_up[m_n_D0trks_side1_up][5] = 2;
                                ppi.setPx(KalTrk->p4(mpi)[0]);
                                ppi.setPy(KalTrk->p4(mpi)[1]);
                                ppi.setPz(KalTrk->p4(mpi)[2]);
                                ppi.setE(KalTrk->p4(mpi)[3]);
                                if (runNo < 0) m_rawp4_D0trks_side1_up[m_n_D0trks_side1_up][6] = MatchMC(ppi, "D0_tag");
                                else m_rawp4_D0trks_side1_up[m_n_D0trks_side1_up][6] = -999;
                                if (runNo < 0) m_rawp4_D0trks_side1_up[m_n_D0trks_side1_up][7] = MatchMC(ppi, "Dm_tag");
                                else m_rawp4_D0trks_side1_up[m_n_D0trks_side1_up][7] = -999;
                                HepVector a = KalTrk->getZHelixK();
                                HepSymMatrix Ea = KalTrk->getZErrorK();
                                HepPoint3D point0(0., 0., 0.);
                            ...
                            if (m_sample_types[mm] == "side2_low") {
                                for (int k = 0; k < 4; k++) m_rawp4_D0trks_side2_low[m_n_D0trks_side2_low][k] = KalTrk->p4(mpi)[k];
                                m_rawp4_D0trks_side2_low[m_n_D0trks_side2_low][4] = KalTrk->charge();
                                m_rawp4_D0trks_side2_low[m_n_D0trks_side2_low][5] = 2;
                                ppi.setPx(KalTrk->p4(mpi)[0]);
                                ppi.setPy(KalTrk->p4(mpi)[1]);
                                ppi.setPz(KalTrk->p4(mpi)[2]);
                                ppi.setE(KalTrk->p4(mpi)[3]);
                                if (runNo < 0) m_rawp4_D0trks_side2_low[m_n_D0trks_side2_low][6] = MatchMC(ppi, "D0_tag");
                                else m_rawp4_D0trks_side2_low[m_n_D0trks_side2_low][6] = -999;
                                if (runNo < 0) m_rawp4_D0trks_side2_low[m_n_D0trks_side2_low][7] = MatchMC(ppi, "Dm_tag");
                                else m_rawp4_D0trks_side2_low[m_n_D0trks_side2_low][7] = -999;
                                HepVector a = KalTrk->getZHelixK();
                                HepSymMatrix Ea = KalTrk->getZErrorK();
                                HepPoint3D point0(0., 0., 0.);
                            ...
                            if (m_sample_types[mm] == "side2_up") {
                                for (int k = 0; k < 4; k++) m_rawp4_D0trks_side2_up[m_n_D0trks_side2_up][k] = KalTrk->p4(mpi)[k];
                                m_rawp4_D0trks_side2_up[m_n_D0trks_side2_up][4] = KalTrk->charge();
                                m_rawp4_D0trks_side2_up[m_n_D0trks_side2_up][5] = 2;
                                ppi.setPx(KalTrk->p4(mpi)[0]);
                                ppi.setPy(KalTrk->p4(mpi)[1]);
                                ppi.setPz(KalTrk->p4(mpi)[2]);
                                ppi.setE(KalTrk->p4(mpi)[3]);
                                if (runNo < 0) m_rawp4_D0trks_side2_up[m_n_D0trks_side2_up][6] = MatchMC(ppi, "D0_tag");
                                else m_rawp4_D0trks_side2_up[m_n_D0trks_side2_up][6] = -999;
                                if (runNo < 0) m_rawp4_D0trks_side2_up[m_n_D0trks_side2_up][7] = MatchMC(ppi, "Dm_tag");
                                else m_rawp4_D0trks_side2_up[m_n_D0trks_side2_up][7] = -999;
                                HepVector a = KalTrk->getZHelixK();
                                HepSymMatrix Ea = KalTrk->getZErrorK();
                                HepPoint3D point0(0., 0., 0.);
                            ...
                            if (m_sample_types[mm] == "side3_low") {
                                for (int k = 0; k < 4; k++) m_rawp4_D0trks_side3_low[m_n_D0trks_side3_low][k] = KalTrk->p4(mpi)[k];
                                m_rawp4_D0trks_side3_low[m_n_D0trks_side3_low][4] = KalTrk->charge();
                                m_rawp4_D0trks_side3_low[m_n_D0trks_side3_low][5] = 2;
                                ppi.setPx(KalTrk->p4(mpi)[0]);
                                ppi.setPy(KalTrk->p4(mpi)[1]);
                                ppi.setPz(KalTrk->p4(mpi)[2]);
                                ppi.setE(KalTrk->p4(mpi)[3]);
                                if (runNo < 0) m_rawp4_D0trks_side3_low[m_n_D0trks_side3_low][6] = MatchMC(ppi, "D0_tag");
                                else m_rawp4_D0trks_side3_low[m_n_D0trks_side3_low][6] = -999;
                                if (runNo < 0) m_rawp4_D0trks_side3_low[m_n_D0trks_side3_low][7] = MatchMC(ppi, "Dm_tag");
                                else m_rawp4_D0trks_side3_low[m_n_D0trks_side3_low][7] = -999;
                                HepVector a = KalTrk->getZHelixK();
                                HepSymMatrix Ea = KalTrk->getZErrorK();
                                HepPoint3D point0(0., 0., 0.);
                            ...
                            if (m_sample_types[mm] == "side3_up") {
                                for (int k = 0; k < 4; k++) m_rawp4_D0trks_side3_up[m_n_D0trks_side3_up][k] = KalTrk->p4(mpi)[k];
                                m_rawp4_D0trks_side3_up[m_n_D0trks_side3_up][4] = KalTrk->charge();
                                m_rawp4_D0trks_side3_up[m_n_D0trks_side3_up][5] = 2;
                                ppi.setPx(KalTrk->p4(mpi)[0]);
                                ppi.setPy(KalTrk->p4(mpi)[1]);
                                ppi.setPz(KalTrk->p4(mpi)[2]);
                                ppi.setE(KalTrk->p4(mpi)[3]);
                                if (runNo < 0) m_rawp4_D0trks_side3_up[m_n_D0trks_side3_up][6] = MatchMC(ppi, "D0_tag");
                                else m_rawp4_D0trks_side3_up[m_n_D0trks_side3_up][6] = -999;
                                if (runNo < 0) m_rawp4_D0trks_side3_up[m_n_D0trks_side3_up][7] = MatchMC(ppi, "Dm_tag");
                                else m_rawp4_D0trks_side3_up[m_n_D0trks_side3_up][7] = -999;
                                HepVector a = KalTrk->getZHelixK();
                                HepSymMatrix Ea = KalTrk->getZErrorK();
                                HepPoint3D point0(0., 0., 0.);
                            ...
                            if (m_sample_types[mm] == "side4_low") {
                                for (int k = 0; k < 4; k++) m_rawp4_D0trks_side4_low[m_n_D0trks_side4_low][k] = KalTrk->p4(mpi)[k];
                                m_rawp4_D0trks_side4_low[m_n_D0trks_side4_low][4] = KalTrk->charge();
                                m_rawp4_D0trks_side4_low[m_n_D0trks_side4_low][5] = 2;
                                ppi.setPx(KalTrk->p4(mpi)[0]);
                                ppi.setPy(KalTrk->p4(mpi)[1]);
                                ppi.setPz(KalTrk->p4(mpi)[2]);
                                ppi.setE(KalTrk->p4(mpi)[3]);
                                if (runNo < 0) m_rawp4_D0trks_side4_low[m_n_D0trks_side4_low][6] = MatchMC(ppi, "D0_tag");
                                else m_rawp4_D0trks_side4_low[m_n_D0trks_side4_low][6] = -999;
                                if (runNo < 0) m_rawp4_D0trks_side4_low[m_n_D0trks_side4_low][7] = MatchMC(ppi, "Dm_tag");
                                else m_rawp4_D0trks_side4_low[m_n_D0trks_side4_low][7] = -999;
                                HepVector a = KalTrk->getZHelixK();
                                HepSymMatrix Ea = KalTrk->getZErrorK();
                                HepPoint3D point0(0., 0., 0.);
                            ...
                            if (m_sample_types[mm] == "side4_up") {
                                for (int k = 0; k < 4; k++) m_rawp4_D0trks_side4_up[m_n_D0trks_side4_up][k] = KalTrk->p4(mpi)[k];
                                m_rawp4_D0trks_side4_up[m_n_D0trks_side4_up][4] = KalTrk->charge();
                                m_rawp4_D0trks_side4_up[m_n_D0trks_side4_up][5] = 2;
                                ppi.setPx(KalTrk->p4(mpi)[0]);
                                ppi.setPy(KalTrk->p4(mpi)[1]);
                                ppi.setPz(KalTrk->p4(mpi)[2]);
                                ppi.setE(KalTrk->p4(mpi)[3]);
                                if (runNo < 0) m_rawp4_D0trks_side4_up[m_n_D0trks_side4_up][6] = MatchMC(ppi, "D0_tag");
                                else m_rawp4_D0trks_side4_up[m_n_D0trks_side4_up][6] = -999;
                                if (runNo < 0) m_rawp4_D0trks_side4_up[m_n_D0trks_side4_up][7] = MatchMC(ppi, "Dm_tag");
                                else m_rawp4_D0trks_side4_up[m_n_D0trks_side4_up][7] = -999;
                                HepVector a = KalTrk->getZHelixK();
                                HepSymMatrix Ea = KalTrk->getZErrorK();
                                HepPoint3D point0(0., 0., 0.);
                        ...
                        if (m_sample_types[mm] == "signal") m_n_D0trks_signal++;
                        if (m_sample_types[mm] == "side1_low") m_n_D0trks_side1_low++;
                        if (m_sample_types[mm] == "side1_up") m_n_D0trks_side1_up++;
                        if (m_sample_types[mm] == "side2_low") m_n_D0trks_side2_low++;
                        if (m_sample_types[mm] == "side2_up") m_n_D0trks_side2_up++;
                        if (m_sample_types[mm] == "side3_low") m_n_D0trks_side3_low++;
                        if (m_sample_types[mm] == "side3_up") m_n_D0trks_side3_up++;
                        if (m_sample_types[mm] == "side4_low") m_n_D0trks_side4_low++;
                        if (m_sample_types[mm] == "side4_up") m_n_D0trks_side4_up++;
                    }
                    if (m_sample_types[mm] == "signal") m_n_Dmtrks_signal = 0;
                    if (m_sample_types[mm] == "side1_low") m_n_Dmtrks_side1_low = 0;
                    if (m_sample_types[mm] == "side1_up") m_n_Dmtrks_side1_up = 0;
                    if (m_sample_types[mm] == "side2_low") m_n_Dmtrks_side2_low = 0;
                    if (m_sample_types[mm] == "side2_up") m_n_Dmtrks_side2_up = 0;
                    if (m_sample_types[mm] == "side3_low") m_n_Dmtrks_side3_low = 0;
                    if (m_sample_types[mm] == "side3_up") m_n_Dmtrks_side3_up = 0;
                    if (m_sample_types[mm] == "side4_low") m_n_Dmtrks_side4_low = 0;
                    if (m_sample_types[mm] == "side4_up") m_n_Dmtrks_side4_up = 0;
                    for (int trk2 = 0; trk2 < Tracks2.size(); trk2++) {
                        ...
                        if (dtagTool.isKaon(Tracks2[trk2])) {
                            ...
                            vwtrkpara_charge.push_back(WTrackParameter(mka, KalTrk->getZHelixK(), KalTrk->getZErrorK()));
                            if (m_sample_types[mm] == "signal") {
                                for (int k = 0; k < 4; k++) m_rawp4_Dmtrks_signal[m_n_Dmtrks_signal][k] = KalTrk->p4(mka)[k];
                                m_rawp4_Dmtrks_signal[m_n_Dmtrks_signal][4] = KalTrk->charge();
                                m_rawp4_Dmtrks_signal[m_n_Dmtrks_signal][5] = 3;
                                pK.setPx(KalTrk->p4(mka)[0]);
                                pK.setPy(KalTrk->p4(mka)[1]);
                                pK.setPz(KalTrk->p4(mka)[2]);
                                pK.setE(KalTrk->p4(mka)[3]);
                                if (runNo < 0) m_rawp4_Dmtrks_signal[m_n_Dmtrks_signal][6] = MatchMC(pK, "Dm_tag");
                                else m_rawp4_Dmtrks_signal[m_n_Dmtrks_signal][6] = -999;
                                if (runNo < 0) m_rawp4_Dmtrks_signal[m_n_Dmtrks_signal][7] = MatchMC(pK, "D0_tag");
                                else m_rawp4_Dmtrks_signal[m_n_Dmtrks_signal][7] = -999;
                                HepVector a = KalTrk->getZHelixK();
                                HepSymMatrix Ea = KalTrk->getZErrorK();
                                HepPoint3D point0(0., 0., 0.);
                                HepPoint3D IP(xorigin[0], xorigin[1], xorigin[2]);
                                ...
                                helixip.pivot(IP);
                                HepVector vecipa = helixip.a();
                                m_vtx_Dmtrks_signal[m_n_Dmtrks_signal][0] = fabs(vecipa[0]);
                                m_vtx_Dmtrks_signal[m_n_Dmtrks_signal][1] = fabs(vecipa[3]);
                                m_vtx_Dmtrks_signal[m_n_Dmtrks_signal][2] = cos(KalTrk->theta());
                            }
                            if (m_sample_types[mm] == "side1_low") {
                                for (int k = 0; k < 4; k++) m_rawp4_Dmtrks_side1_low[m_n_Dmtrks_side1_low][k] = KalTrk->p4(mka)[k];
                                m_rawp4_Dmtrks_side1_low[m_n_Dmtrks_side1_low][4] = KalTrk->charge();
                                m_rawp4_Dmtrks_side1_low[m_n_Dmtrks_side1_low][5] = 3;
                                pK.setPx(KalTrk->p4(mka)[0]);
                                pK.setPy(KalTrk->p4(mka)[1]);
                                pK.setPz(KalTrk->p4(mka)[2]);
                                pK.setE(KalTrk->p4(mka)[3]);
                                if (runNo < 0) m_rawp4_Dmtrks_side1_low[m_n_Dmtrks_side1_low][6] = MatchMC(pK, "Dm_tag");
                                else m_rawp4_Dmtrks_side1_low[m_n_Dmtrks_side1_low][6] = -999;
                                if (runNo < 0) m_rawp4_Dmtrks_side1_low[m_n_Dmtrks_side1_low][7] = MatchMC(pK, "D0_tag");
                                else m_rawp4_Dmtrks_side1_low[m_n_Dmtrks_side1_low][7] = -999;
                                HepVector a = KalTrk->getZHelixK();
                                HepSymMatrix Ea = KalTrk->getZErrorK();
                                HepPoint3D point0(0., 0., 0.);
                                HepPoint3D IP(xorigin[0], xorigin[1], xorigin[2]);
                                ...
                                helixip.pivot(IP);
                                HepVector vecipa = helixip.a();
                                m_vtx_Dmtrks_side1_low[m_n_Dmtrks_side1_low][0] = fabs(vecipa[0]);
                                m_vtx_Dmtrks_side1_low[m_n_Dmtrks_side1_low][1] = fabs(vecipa[3]);
                                m_vtx_Dmtrks_side1_low[m_n_Dmtrks_side1_low][2] = cos(KalTrk->theta());
                            }
                            if (m_sample_types[mm] == "side1_up") {
                                for (int k = 0; k < 4; k++) m_rawp4_Dmtrks_side1_up[m_n_Dmtrks_side1_up][k] = KalTrk->p4(mka)[k];
                                m_rawp4_Dmtrks_side1_up[m_n_Dmtrks_side1_up][4] = KalTrk->charge();
                                m_rawp4_Dmtrks_side1_up[m_n_Dmtrks_side1_up][5] = 3;
                                pK.setPx(KalTrk->p4(mka)[0]);
                                pK.setPy(KalTrk->p4(mka)[1]);
                                pK.setPz(KalTrk->p4(mka)[2]);
                                pK.setE(KalTrk->p4(mka)[3]);
                                if (runNo < 0) m_rawp4_Dmtrks_side1_up[m_n_Dmtrks_side1_up][6] = MatchMC(pK, "Dm_tag");
                                else m_rawp4_Dmtrks_side1_up[m_n_Dmtrks_side1_up][6] = -999;
                                if (runNo < 0) m_rawp4_Dmtrks_side1_up[m_n_Dmtrks_side1_up][7] = MatchMC(pK, "D0_tag");
                                else m_rawp4_Dmtrks_side1_up[m_n_Dmtrks_side1_up][7] = -999;
                                HepVector a = KalTrk->getZHelixK();
                                HepSymMatrix Ea = KalTrk->getZErrorK();
                                HepPoint3D point0(0., 0., 0.);
                                HepPoint3D IP(xorigin[0], xorigin[1], xorigin[2]);
                                ...
                                helixip.pivot(IP);
                                HepVector vecipa = helixip.a();
                                m_vtx_Dmtrks_side1_up[m_n_Dmtrks_side1_up][0] = fabs(vecipa[0]);
                                m_vtx_Dmtrks_side1_up[m_n_Dmtrks_side1_up][1] = fabs(vecipa[3]);
                                m_vtx_Dmtrks_side1_up[m_n_Dmtrks_side1_up][2] = cos(KalTrk->theta());
                            }
                            if (m_sample_types[mm] == "side2_low") {
                                for (int k = 0; k < 4; k++) m_rawp4_Dmtrks_side2_low[m_n_Dmtrks_side2_low][k] = KalTrk->p4(mka)[k];
                                m_rawp4_Dmtrks_side2_low[m_n_Dmtrks_side2_low][4] = KalTrk->charge();
                                m_rawp4_Dmtrks_side2_low[m_n_Dmtrks_side2_low][5] = 3;
                                pK.setPx(KalTrk->p4(mka)[0]);
                                pK.setPy(KalTrk->p4(mka)[1]);
                                pK.setPz(KalTrk->p4(mka)[2]);
                                pK.setE(KalTrk->p4(mka)[3]);
                                if (runNo < 0) m_rawp4_Dmtrks_side2_low[m_n_Dmtrks_side2_low][6] = MatchMC(pK, "Dm_tag");
                                else m_rawp4_Dmtrks_side2_low[m_n_Dmtrks_side2_low][6] = -999;
                                if (runNo < 0) m_rawp4_Dmtrks_side2_low[m_n_Dmtrks_side2_low][7] = MatchMC(pK, "D0_tag");
                                else m_rawp4_Dmtrks_side2_low[m_n_Dmtrks_side2_low][7] = -999;
                                HepVector a = KalTrk->getZHelixK();
                                HepSymMatrix Ea = KalTrk->getZErrorK();
                                HepPoint3D point0(0., 0., 0.);
                                HepPoint3D IP(xorigin[0], xorigin[1], xorigin[2]);
                                ...
                                helixip.pivot(IP);
                                HepVector vecipa = helixip.a();
                                m_vtx_Dmtrks_side2_low[m_n_Dmtrks_side2_low][0] = fabs(vecipa[0]);
                                m_vtx_Dmtrks_side2_low[m_n_Dmtrks_side2_low][1] = fabs(vecipa[3]);
                                m_vtx_Dmtrks_side2_low[m_n_Dmtrks_side2_low][2] = cos(KalTrk->theta());
                            }
                            if (m_sample_types[mm] == "side2_up") {
                                for (int k = 0; k < 4; k++) m_rawp4_Dmtrks_side2_up[m_n_Dmtrks_side2_up][k] = KalTrk->p4(mka)[k];
                                m_rawp4_Dmtrks_side2_up[m_n_Dmtrks_side2_up][4] = KalTrk->charge();
                                m_rawp4_Dmtrks_side2_up[m_n_Dmtrks_side2_up][5] = 3;
                                pK.setPx(KalTrk->p4(mka)[0]);
                                pK.setPy(KalTrk->p4(mka)[1]);
                                pK.setPz(KalTrk->p4(mka)[2]);
                                pK.setE(KalTrk->p4(mka)[3]);
                                if (runNo < 0) m_rawp4_Dmtrks_side2_up[m_n_Dmtrks_side2_up][6] = MatchMC(pK, "Dm_tag");
                                else m_rawp4_Dmtrks_side2_up[m_n_Dmtrks_side2_up][6] = -999;
                                if (runNo < 0) m_rawp4_Dmtrks_side2_up[m_n_Dmtrks_side2_up][7] = MatchMC(pK, "D0_tag");
                                else m_rawp4_Dmtrks_side2_up[m_n_Dmtrks_side2_up][7] = -999;
                                HepVector a = KalTrk->getZHelixK();
                                HepSymMatrix Ea = KalTrk->getZErrorK();
                                HepPoint3D point0(0., 0., 0.);
                                HepPoint3D IP(xorigin[0], xorigin[1], xorigin[2]);
                                ...
                                helixip.pivot(IP);
                                HepVector vecipa = helixip.a();
                                m_vtx_Dmtrks_side2_up[m_n_Dmtrks_side2_up][0] = fabs(vecipa[0]);
                                m_vtx_Dmtrks_side2_up[m_n_Dmtrks_side2_up][1] = fabs(vecipa[3]);
                                m_vtx_Dmtrks_side2_up[m_n_Dmtrks_side2_up][2] = cos(KalTrk->theta());
                            }
                            if (m_sample_types[mm] == "side3_low") {
                                for (int k = 0; k < 4; k++) m_rawp4_Dmtrks_side3_low[m_n_Dmtrks_side3_low][k] = KalTrk->p4(mka)[k];
                                m_rawp4_Dmtrks_side3_low[m_n_Dmtrks_side3_low][4] = KalTrk->charge();
                                m_rawp4_Dmtrks_side3_low[m_n_Dmtrks_side3_low][5] = 3;
                                pK.setPx(KalTrk->p4(mka)[0]);
                                pK.setPy(KalTrk->p4(mka)[1]);
                                pK.setPz(KalTrk->p4(mka)[2]);
                                pK.setE(KalTrk->p4(mka)[3]);
                                if (runNo < 0) m_rawp4_Dmtrks_side3_low[m_n_Dmtrks_side3_low][6] = MatchMC(pK, "Dm_tag");
                                else m_rawp4_Dmtrks_side3_low[m_n_Dmtrks_side3_low][6] = -999;
                                if (runNo < 0) m_rawp4_Dmtrks_side3_low[m_n_Dmtrks_side3_low][7] = MatchMC(pK, "D0_tag");
                                else m_rawp4_Dmtrks_side3_low[m_n_Dmtrks_side3_low][7] = -999;
                                HepVector a = KalTrk->getZHelixK();
                                HepSymMatrix Ea = KalTrk->getZErrorK();
                                HepPoint3D point0(0., 0., 0.);
                                HepPoint3D IP(xorigin[0], xorigin[1], xorigin[2]);
                                ...
                                helixip.pivot(IP);
                                HepVector vecipa = helixip.a();
                                m_vtx_Dmtrks_side3_low[m_n_Dmtrks_side3_low][0] = fabs(vecipa[0]);
                                m_vtx_Dmtrks_side3_low[m_n_Dmtrks_side3_low][1] = fabs(vecipa[3]);
                                m_vtx_Dmtrks_side3_low[m_n_Dmtrks_side3_low][2] = cos(KalTrk->theta());
                            }
                            if (m_sample_types[mm] == "side3_up") {
                                for (int k = 0; k < 4; k++) m_rawp4_Dmtrks_side3_up[m_n_Dmtrks_side3_up][k] = KalTrk->p4(mka)[k];
                                m_rawp4_Dmtrks_side3_up[m_n_Dmtrks_side3_up][4] = KalTrk->charge();
                                m_rawp4_Dmtrks_side3_up[m_n_Dmtrks_side3_up][5] = 3;
                                pK.setPx(KalTrk->p4(mka)[0]);
                                pK.setPy(KalTrk->p4(mka)[1]);
                                pK.setPz(KalTrk->p4(mka)[2]);
                                pK.setE(KalTrk->p4(mka)[3]);
                                if (runNo < 0) m_rawp4_Dmtrks_side3_up[m_n_Dmtrks_side3_up][6] = MatchMC(pK, "Dm_tag");
                                else m_rawp4_Dmtrks_side3_up[m_n_Dmtrks_side3_up][6] = -999;
                                if (runNo < 0) m_rawp4_Dmtrks_side3_up[m_n_Dmtrks_side3_up][7] = MatchMC(pK, "D0_tag");
                                else m_rawp4_Dmtrks_side3_up[m_n_Dmtrks_side3_up][7] = -999;
                                HepVector a = KalTrk->getZHelixK();
                                HepSymMatrix Ea = KalTrk->getZErrorK();
                                HepPoint3D point0(0., 0., 0.);
                                HepPoint3D IP(xorigin[0], xorigin[1], xorigin[2]);
                                ...
                                helixip.pivot(IP);
                                HepVector vecipa = helixip.a();
                                m_vtx_Dmtrks_side3_up[m_n_Dmtrks_side3_up][0] = fabs(vecipa[0]);
                                m_vtx_Dmtrks_side3_up[m_n_Dmtrks_side3_up][1] = fabs(vecipa[3]);
                                m_vtx_Dmtrks_side3_up[m_n_Dmtrks_side3_up][2] = cos(KalTrk->theta());
                            }
                            if (m_sample_types[mm] == "side4_low") {
                                for (int k = 0; k < 4; k++) m_rawp4_Dmtrks_side4_low[m_n_Dmtrks_side4_low][k] = KalTrk->p4(mka)[k];
                                m_rawp4_Dmtrks_side4_low[m_n_Dmtrks_side4_low][4] = KalTrk->charge();
                                m_rawp4_Dmtrks_side4_low[m_n_Dmtrks_side4_low][5] = 3;
                                pK.setPx(KalTrk->p4(mka)[0]);
                                pK.setPy(KalTrk->p4(mka)[1]);
                                pK.setPz(KalTrk->p4(mka)[2]);
                                pK.setE(KalTrk->p4(mka)[3]);
                                if (runNo < 0) m_rawp4_Dmtrks_side4_low[m_n_Dmtrks_side4_low][6] = MatchMC(pK, "Dm_tag");
                                else m_rawp4_Dmtrks_side4_low[m_n_Dmtrks_side4_low][6] = -999;
                                if (runNo < 0) m_rawp4_Dmtrks_side4_low[m_n_Dmtrks_side4_low][7] = MatchMC(pK, "D0_tag");
                                else m_rawp4_Dmtrks_side4_low[m_n_Dmtrks_side4_low][7] = -999;
                                HepVector a = KalTrk->getZHelixK();
                                HepSymMatrix Ea = KalTrk->getZErrorK();
                                HepPoint3D point0(0., 0., 0.);
                                HepPoint3D IP(xorigin[0], xorigin[1], xorigin[2]);
                                ...
                                helixip.pivot(IP);
                                HepVector vecipa = helixip.a();
                                m_vtx_Dmtrks_side4_low[m_n_Dmtrks_side4_low][0] = fabs(vecipa[0]);
                                m_vtx_Dmtrks_side4_low[m_n_Dmtrks_side4_low][1] = fabs(vecipa[3]);
                                m_vtx_Dmtrks_side4_low[m_n_Dmtrks_side4_low][2] = cos(KalTrk->theta());
                            }
                            if (m_sample_types[mm] == "side4_up") {
                                for (int k = 0; k < 4; k++) m_rawp4_Dmtrks_side4_up[m_n_Dmtrks_side4_up][k] = KalTrk->p4(mka)[k];
                                m_rawp4_Dmtrks_side4_up[m_n_Dmtrks_side4_up][4] = KalTrk->charge();
                                m_rawp4_Dmtrks_side4_up[m_n_Dmtrks_side4_up][5] = 3;
                                pK.setPx(KalTrk->p4(mka)[0]);
                                pK.setPy(KalTrk->p4(mka)[1]);
                                pK.setPz(KalTrk->p4(mka)[2]);
                                pK.setE(KalTrk->p4(mka)[3]);
                                if (runNo < 0) m_rawp4_Dmtrks_side4_up[m_n_Dmtrks_side4_up][6] = MatchMC(pK, "Dm_tag");
                                else m_rawp4_Dmtrks_side4_up[m_n_Dmtrks_side4_up][6] = -999;
                                if (runNo < 0) m_rawp4_Dmtrks_side4_up[m_n_Dmtrks_side4_up][7] = MatchMC(pK, "D0_tag");
                                else m_rawp4_Dmtrks_side4_up[m_n_Dmtrks_side4_up][7] = -999;
                                HepVector a = KalTrk->getZHelixK();
                                HepSymMatrix Ea = KalTrk->getZErrorK();
                                HepPoint3D point0(0., 0., 0.);
                                HepPoint3D IP(xorigin[0], xorigin[1], xorigin[2]);
                                ...
                                helixip.pivot(IP);
                                HepVector vecipa = helixip.a();
                                m_vtx_Dmtrks_side4_up[m_n_Dmtrks_side4_up][0] = fabs(vecipa[0]);
                                m_vtx_Dmtrks_side4_up[m_n_Dmtrks_side4_up][1] = fabs(vecipa[3]);
                                m_vtx_Dmtrks_side4_up[m_n_Dmtrks_side4_up][2] = cos(KalTrk->theta());
                            }
                        }
                        else {
                            KalTrk->setPidType(RecMdcKalTrack::pion);
                            vwtrkpara_charge.push_back(WTrackParameter(mpi, KalTrk->getZHelixK(), KalTrk->getZErrorK()));
                            if (m_sample_types[mm] == "signal") {
                                for (int k = 0; k < 4; k++) m_rawp4_Dmtrks_signal[m_n_Dmtrks_signal][k] = KalTrk->p4(mpi)[k];
                                m_rawp4_Dmtrks_signal[m_n_Dmtrks_signal][4] = KalTrk->charge();
                                m_rawp4_Dmtrks_signal[m_n_Dmtrks_signal][5] = 2;
                                ppi.setPx(KalTrk->p4(mpi)[0]);
                                ppi.setPy(KalTrk->p4(mpi)[1]);
                                ppi.setPz(KalTrk->p4(mpi)[2]);
                                ppi.setE(KalTrk->p4(mpi)[3]);
                                if (runNo < 0) m_rawp4_Dmtrks_signal[m_n_Dmtrks_signal][6] = MatchMC(ppi, "Dm_tag");
                                else m_rawp4_Dmtrks_signal[m_n_Dmtrks_signal][6] = -999;
                                if (runNo < 0) m_rawp4_Dmtrks_signal[m_n_Dmtrks_signal][7] = MatchMC(ppi, "D0_tag");
                                else m_rawp4_Dmtrks_signal[m_n_Dmtrks_signal][7] = -999;
                                HepVector a = KalTrk->getZHelixK();
                                HepSymMatrix Ea = KalTrk->getZErrorK();
                                HepPoint3D point0(0., 0., 0.);
                            ...
                            if (m_sample_types[mm] == "side1_low") {
                                for (int k = 0; k < 4; k++) m_rawp4_Dmtrks_side1_low[m_n_Dmtrks_side1_low][k] = KalTrk->p4(mpi)[k];
                                m_rawp4_Dmtrks_side1_low[m_n_Dmtrks_side1_low][4] = KalTrk->charge();
                                m_rawp4_Dmtrks_side1_low[m_n_Dmtrks_side1_low][5] = 2;
                                ppi.setPx(KalTrk->p4(mpi)[0]);
                                ppi.setPy(KalTrk->p4(mpi)[1]);
                                ppi.setPz(KalTrk->p4(mpi)[2]);
                                ppi.setE(KalTrk->p4(mpi)[3]);
                                if (runNo < 0) m_rawp4_Dmtrks_side1_low[m_n_Dmtrks_side1_low][6] = MatchMC(ppi, "Dm_tag");
                                else m_rawp4_Dmtrks_side1_low[m_n_Dmtrks_side1_low][6] = -999;
                                if (runNo < 0) m_rawp4_Dmtrks_side1_low[m_n_Dmtrks_side1_low][7] = MatchMC(ppi, "D0_tag");
                                else m_rawp4_Dmtrks_side1_low[m_n_Dmtrks_side1_low][7] = -999;
                                HepVector a = KalTrk->getZHelixK();
                                HepSymMatrix Ea = KalTrk->getZErrorK();
                                HepPoint3D point0(0., 0., 0.);
                            ...
                            if (m_sample_types[mm] == "side1_up") {
                                for (int k = 0; k < 4; k++) m_rawp4_Dmtrks_side1_up[m_n_Dmtrks_side1_up][k] = KalTrk->p4(mpi)[k];
                                m_rawp4_Dmtrks_side1_up[m_n_Dmtrks_side1_up][4] = KalTrk->charge();
                                m_rawp4_Dmtrks_side1_up[m_n_Dmtrks_side1_up][5] = 2;
                                ppi.setPx(KalTrk->p4(mpi)[0]);
                                ppi.setPy(KalTrk->p4(mpi)[1]);
                                ppi.setPz(KalTrk->p4(mpi)[2]);
                                ppi.setE(KalTrk->p4(mpi)[3]);
                                if (runNo < 0) m_rawp4_Dmtrks_side1_up[m_n_Dmtrks_side1_up][6] = MatchMC(ppi, "Dm_tag");
                                else m_rawp4_Dmtrks_side1_up[m_n_Dmtrks_side1_up][6] = -999;
                                if (runNo < 0) m_rawp4_Dmtrks_side1_up[m_n_Dmtrks_side1_up][7] = MatchMC(ppi, "D0_tag");
                                else m_rawp4_Dmtrks_side1_up[m_n_Dmtrks_side1_up][7] = -999;
                                HepVector a = KalTrk->getZHelixK();
                                HepSymMatrix Ea = KalTrk->getZErrorK();
                                HepPoint3D point0(0., 0., 0.);
                            ...
                            if (m_sample_types[mm] == "side2_low") {
                                for (int k = 0; k < 4; k++) m_rawp4_Dmtrks_side2_low[m_n_Dmtrks_side2_low][k] = KalTrk->p4(mpi)[k];
                                m_rawp4_Dmtrks_side2_low[m_n_Dmtrks_side2_low][4] = KalTrk->charge();
                                m_rawp4_Dmtrks_side2_low[m_n_Dmtrks_side2_low][5] = 2;
                                ppi.setPx(KalTrk->p4(mpi)[0]);
                                ppi.setPy(KalTrk->p4(mpi)[1]);
                                ppi.setPz(KalTrk->p4(mpi)[2]);
                                ppi.setE(KalTrk->p4(mpi)[3]);
                                if (runNo < 0) m_rawp4_Dmtrks_side2_low[m_n_Dmtrks_side2_low][6] = MatchMC(ppi, "Dm_tag");
                                else m_rawp4_Dmtrks_side2_low[m_n_Dmtrks_side2_low][6] = -999;
                                if (runNo < 0) m_rawp4_Dmtrks_side2_low[m_n_Dmtrks_side2_low][7] = MatchMC(ppi, "D0_tag");
                                else m_rawp4_Dmtrks_side2_low[m_n_Dmtrks_side2_low][7] = -999;
                                HepVector a = KalTrk->getZHelixK();
                                HepSymMatrix Ea = KalTrk->getZErrorK();
                                HepPoint3D point0(0., 0., 0.);
                            ...
                            if (m_sample_types[mm] == "side2_up") {
                                for (int k = 0; k < 4; k++) m_rawp4_Dmtrks_side2_up[m_n_Dmtrks_side2_up][k] = KalTrk->p4(mpi)[k];
                                m_rawp4_Dmtrks_side2_up[m_n_Dmtrks_side2_up][4] = KalTrk->charge();
                                m_rawp4_Dmtrks_side2_up[m_n_Dmtrks_side2_up][5] = 2;
                                ppi.setPx(KalTrk->p4(mpi)[0]);
                                ppi.setPy(KalTrk->p4(mpi)[1]);
                                ppi.setPz(KalTrk->p4(mpi)[2]);
                                ppi.setE(KalTrk->p4(mpi)[3]);
                                if (runNo < 0) m_rawp4_Dmtrks_side2_up[m_n_Dmtrks_side2_up][6] = MatchMC(ppi, "Dm_tag");
                                else m_rawp4_Dmtrks_side2_up[m_n_Dmtrks_side2_up][6] = -999;
                                if (runNo < 0) m_rawp4_Dmtrks_side2_up[m_n_Dmtrks_side2_up][7] = MatchMC(ppi, "D0_tag");
                                else m_rawp4_Dmtrks_side2_up[m_n_Dmtrks_side2_up][7] = -999;
                                HepVector a = KalTrk->getZHelixK();
                                HepSymMatrix Ea = KalTrk->getZErrorK();
                                HepPoint3D point0(0., 0., 0.);
                            ...
                            if (m_sample_types[mm] == "side3_low") {
                                for (int k = 0; k < 4; k++) m_rawp4_Dmtrks_side3_low[m_n_Dmtrks_side3_low][k] = KalTrk->p4(mpi)[k];
                                m_rawp4_Dmtrks_side3_low[m_n_Dmtrks_side3_low][4] = KalTrk->charge();
                                m_rawp4_Dmtrks_side3_low[m_n_Dmtrks_side3_low][5] = 2;
                                ppi.setPx(KalTrk->p4(mpi)[0]);
                                ppi.setPy(KalTrk->p4(mpi)[1]);
                                ppi.setPz(KalTrk->p4(mpi)[2]);
                                ppi.setE(KalTrk->p4(mpi)[3]);
                                if (runNo < 0) m_rawp4_Dmtrks_side3_low[m_n_Dmtrks_side3_low][6] = MatchMC(ppi, "Dm_tag");
                                else m_rawp4_Dmtrks_side3_low[m_n_Dmtrks_side3_low][6] = -999;
                                if (runNo < 0) m_rawp4_Dmtrks_side3_low[m_n_Dmtrks_side3_low][7] = MatchMC(ppi, "D0_tag");
                                else m_rawp4_Dmtrks_side3_low[m_n_Dmtrks_side3_low][7] = -999;
                                HepVector a = KalTrk->getZHelixK();
                                HepSymMatrix Ea = KalTrk->getZErrorK();
                                HepPoint3D point0(0., 0., 0.);
                            ...
                            if (m_sample_types[mm] == "side3_up") {
                                for (int k = 0; k < 4; k++) m_rawp4_Dmtrks_side3_up[m_n_Dmtrks_side3_up][k] = KalTrk->p4(mpi)[k];
                                m_rawp4_Dmtrks_side3_up[m_n_Dmtrks_side3_up][4] = KalTrk->charge();
                                m_rawp4_Dmtrks_side3_up[m_n_Dmtrks_side3_up][5] = 2;
                                ppi.setPx(KalTrk->p4(mpi)[0]);
                                ppi.setPy(KalTrk->p4(mpi)[1]);
                                ppi.setPz(KalTrk->p4(mpi)[2]);
                                ppi.setE(KalTrk->p4(mpi)[3]);
                                if (runNo < 0) m_rawp4_Dmtrks_side3_up[m_n_Dmtrks_side3_up][6] = MatchMC(ppi, "Dm_tag");
                                else m_rawp4_Dmtrks_side3_up[m_n_Dmtrks_side3_up][6] = -999;
                                if (runNo < 0) m_rawp4_Dmtrks_side3_up[m_n_Dmtrks_side3_up][7] = MatchMC(ppi, "D0_tag");
                                else m_rawp4_Dmtrks_side3_up[m_n_Dmtrks_side3_up][7] = -999;
                                HepVector a = KalTrk->getZHelixK();
                                HepSymMatrix Ea = KalTrk->getZErrorK();
                                HepPoint3D point0(0., 0., 0.);
                            ...
                            if (m_sample_types[mm] == "side4_low") {
                                for (int k = 0; k < 4; k++) m_rawp4_Dmtrks_side4_low[m_n_Dmtrks_side4_low][k] = KalTrk->p4(mpi)[k];
                                m_rawp4_Dmtrks_side4_low[m_n_Dmtrks_side4_low][4] = KalTrk->charge();
                                m_rawp4_Dmtrks_side4_low[m_n_Dmtrks_side4_low][5] = 2;
                                ppi.setPx(KalTrk->p4(mpi)[0]);
                                ppi.setPy(KalTrk->p4(mpi)[1]);
                                ppi.setPz(KalTrk->p4(mpi)[2]);
                                ppi.setE(KalTrk->p4(mpi)[3]);
                                if (runNo < 0) m_rawp4_Dmtrks_side4_low[m_n_Dmtrks_side4_low][6] = MatchMC(ppi, "Dm_tag");
                                else m_rawp4_Dmtrks_side4_low[m_n_Dmtrks_side4_low][6] = -999;
                                if (runNo < 0) m_rawp4_Dmtrks_side4_low[m_n_Dmtrks_side4_low][7] = MatchMC(ppi, "D0_tag");
                                else m_rawp4_Dmtrks_side4_low[m_n_Dmtrks_side4_low][7] = -999;
                                HepVector a = KalTrk->getZHelixK();
                                HepSymMatrix Ea = KalTrk->getZErrorK();
                                HepPoint3D point0(0., 0., 0.);
                            ...
                            if (m_sample_types[mm] == "side4_up") {
                                for (int k = 0; k < 4; k++) m_rawp4_Dmtrks_side4_up[m_n_Dmtrks_side4_up][k] = KalTrk->p4(mpi)[k];
                                m_rawp4_Dmtrks_side4_up[m_n_Dmtrks_side4_up][4] = KalTrk->charge();
                                m_rawp4_Dmtrks_side4_up[m_n_Dmtrks_side4_up][5] = 2;
                                ppi.setPx(KalTrk->p4(mpi)[0]);
                                ppi.setPy(KalTrk->p4(mpi)[1]);
                                ppi.setPz(KalTrk->p4(mpi)[2]);
                                ppi.setE(KalTrk->p4(mpi)[3]);
                                if (runNo < 0) m_rawp4_Dmtrks_side4_up[m_n_Dmtrks_side4_up][6] = MatchMC(ppi, "Dm_tag");
                                else m_rawp4_Dmtrks_side4_up[m_n_Dmtrks_side4_up][6] = -999;
                                if (runNo < 0) m_rawp4_Dmtrks_side4_up[m_n_Dmtrks_side4_up][7] = MatchMC(ppi, "D0_tag");
                                else m_rawp4_Dmtrks_side4_up[m_n_Dmtrks_side4_up][7] = -999;
                                HepVector a = KalTrk->getZHelixK();
                                HepSymMatrix Ea = KalTrk->getZErrorK();
                                HepPoint3D point0(0., 0., 0.);
                        ...
                        if (m_sample_types[mm] == "signal") m_n_Dmtrks_signal++;
                        if (m_sample_types[mm] == "side1_low") m_n_Dmtrks_side1_low++;
                        if (m_sample_types[mm] == "side1_up") m_n_Dmtrks_side1_up++;
                        if (m_sample_types[mm] == "side2_low") m_n_Dmtrks_side2_low++;
                        if (m_sample_types[mm] == "side2_up") m_n_Dmtrks_side2_up++;
                        if (m_sample_types[mm] == "side3_low") m_n_Dmtrks_side3_low++;
                        if (m_sample_types[mm] == "side3_up") m_n_Dmtrks_side3_up++;
                        if (m_sample_types[mm] == "side4_low") m_n_Dmtrks_side4_low++;
                        if (m_sample_types[mm] == "side4_up") m_n_Dmtrks_side4_up++;
                    }
                    ...
                    // Showers of first D
                    if (m_sample_types[mm] == "signal") m_n_D0shws_signal = 0;
                    if (m_sample_types[mm] == "side1_low") m_n_D0shws_side1_low = 0;
                    if (m_sample_types[mm] == "side1_up") m_n_D0shws_side1_up = 0;
                    if (m_sample_types[mm] == "side2_low") m_n_D0shws_side2_low = 0;
                    if (m_sample_types[mm] == "side2_up") m_n_D0shws_side2_up = 0;
                    if (m_sample_types[mm] == "side3_low") m_n_D0shws_side3_low = 0;
                    if (m_sample_types[mm] == "side3_up") m_n_D0shws_side3_up = 0;
                    if (m_sample_types[mm] == "side4_low") m_n_D0shws_side4_low = 0;
                    if (m_sample_types[mm] == "side4_up") m_n_D0shws_side4_up = 0;
                    for (int i = 0; i < Showers1.size(); i++) {
                        ...
                        if (m_sample_types[mm] == "signal") {
                            for (int j = 0; j < 4; j++) m_rawp4_D0shws_signal[m_n_D0shws_signal][j] = Gm_p4[j];
                            if (runNo < 0) m_rawp4_D0shws_signal[m_n_D0shws_signal][4] = MatchMC(pgam, "D0_tag");
                            else m_rawp4_D0shws_signal[m_n_D0shws_signal][4] = -999;
                            if (runNo < 0) m_rawp4_D0shws_signal[m_n_D0shws_signal][5] = MatchMC(pgam, "Dm_tag");
                            else m_rawp4_D0shws_signal[m_n_D0shws_signal][5] = -999;
                            m_vtx_D0shws_signal[m_n_D0shws_signal][0] = eraw;
                            m_vtx_D0shws_signal[m_n_D0shws_signal][1] = phi;
                            m_vtx_D0shws_signal[m_n_D0shws_signal][2] = the;
                            m_vtx_D0shws_signal[m_n_D0shws_signal][3] = dang;
                            m_vtx_D0shws_signal[m_n_D0shws_signal][4] = module;
                            m_vtx_D0shws_signal[m_n_D0shws_signal][5] = Tdc;
                            m_n_D0shws_signal++;
                        }
                        if (m_sample_types[mm] == "side1_low") {
                            for (int j = 0; j < 4; j++) m_rawp4_D0shws_side1_low[m_n_D0shws_side1_low][j] = Gm_p4[j];
                            if (runNo < 0) m_rawp4_D0shws_side1_low[m_n_D0shws_side1_low][4] = MatchMC(pgam, "D0_tag");
                            else m_rawp4_D0shws_side1_low[m_n_D0shws_side1_low][4] = -999;
                            if (runNo < 0) m_rawp4_D0shws_side1_low[m_n_D0shws_side1_low][5] = MatchMC(pgam, "Dm_tag");
                            else m_rawp4_D0shws_side1_low[m_n_D0shws_side1_low][5] = -999;
                            m_vtx_D0shws_side1_low[m_n_D0shws_side1_low][0] = eraw;
                            m_vtx_D0shws_side1_low[m_n_D0shws_side1_low][1] = phi;
                            m_vtx_D0shws_side1_low[m_n_D0shws_side1_low][2] = the;
                            m_vtx_D0shws_side1_low[m_n_D0shws_side1_low][3] = dang;
                            m_vtx_D0shws_side1_low[m_n_D0shws_side1_low][4] = module;
                            m_vtx_D0shws_side1_low[m_n_D0shws_side1_low][5] = Tdc;
                            m_n_D0shws_side1_low++;
                        }
                        if (m_sample_types[mm] == "side1_up") {
                            for (int j = 0; j < 4; j++) m_rawp4_D0shws_side1_up[m_n_D0shws_side1_up][j] = Gm_p4[j];
                            if (runNo < 0) m_rawp4_D0shws_side1_up[m_n_D0shws_side1_up][4] = MatchMC(pgam, "D0_tag");
                            else m_rawp4_D0shws_side1_up[m_n_D0shws_side1_up][4] = -999;
                            if (runNo < 0) m_rawp4_D0shws_side1_up[m_n_D0shws_side1_up][5] = MatchMC(pgam, "Dm_tag");
                            else m_rawp4_D0shws_side1_up[m_n_D0shws_side1_up][5] = -999;
                            m_vtx_D0shws_side1_up[m_n_D0shws_side1_up][0] = eraw;
                            m_vtx_D0shws_side1_up[m_n_D0shws_side1_up][1] = phi;
                            m_vtx_D0shws_side1_up[m_n_D0shws_side1_up][2] = the;
                            m_vtx_D0shws_side1_up[m_n_D0shws_side1_up][3] = dang;
                            m_vtx_D0shws_side1_up[m_n_D0shws_side1_up][4] = module;
                            m_vtx_D0shws_side1_up[m_n_D0shws_side1_up][5] = Tdc;
                            m_n_D0shws_side1_up++;
                        }
                        if (m_sample_types[mm] == "side2_low") {
                            for (int j = 0; j < 4; j++) m_rawp4_D0shws_side2_low[m_n_D0shws_side2_low][j] = Gm_p4[j];
                            if (runNo < 0) m_rawp4_D0shws_side2_low[m_n_D0shws_side2_low][4] = MatchMC(pgam, "D0_tag");
                            else m_rawp4_D0shws_side2_low[m_n_D0shws_side2_low][4] = -999;
                            if (runNo < 0) m_rawp4_D0shws_side2_low[m_n_D0shws_side2_low][5] = MatchMC(pgam, "Dm_tag");
                            else m_rawp4_D0shws_side2_low[m_n_D0shws_side2_low][5] = -999;
                            m_vtx_D0shws_side2_low[m_n_D0shws_side2_low][0] = eraw;
                            m_vtx_D0shws_side2_low[m_n_D0shws_side2_low][1] = phi;
                            m_vtx_D0shws_side2_low[m_n_D0shws_side2_low][2] = the;
                            m_vtx_D0shws_side2_low[m_n_D0shws_side2_low][3] = dang;
                            m_vtx_D0shws_side2_low[m_n_D0shws_side2_low][4] = module;
                            m_vtx_D0shws_side2_low[m_n_D0shws_side2_low][5] = Tdc;
                            m_n_D0shws_side2_low++;
                        }
                        if (m_sample_types[mm] == "side2_up") {
                            for (int j = 0; j < 4; j++) m_rawp4_D0shws_side2_up[m_n_D0shws_side2_up][j] = Gm_p4[j];
                            if (runNo < 0) m_rawp4_D0shws_side2_up[m_n_D0shws_side2_up][4] = MatchMC(pgam, "D0_tag");
                            else m_rawp4_D0shws_side2_up[m_n_D0shws_side2_up][4] = -999;
                            if (runNo < 0) m_rawp4_D0shws_side2_up[m_n_D0shws_side2_up][5] = MatchMC(pgam, "Dm_tag");
                            else m_rawp4_D0shws_side2_up[m_n_D0shws_side2_up][5] = -999;
                            m_vtx_D0shws_side2_up[m_n_D0shws_side2_up][0] = eraw;
                            m_vtx_D0shws_side2_up[m_n_D0shws_side2_up][1] = phi;
                            m_vtx_D0shws_side2_up[m_n_D0shws_side2_up][2] = the;
                            m_vtx_D0shws_side2_up[m_n_D0shws_side2_up][3] = dang;
                            m_vtx_D0shws_side2_up[m_n_D0shws_side2_up][4] = module;
                            m_vtx_D0shws_side2_up[m_n_D0shws_side2_up][5] = Tdc;
                            m_n_D0shws_side2_up++;
                        }
                        if (m_sample_types[mm] == "side3_low") {
                            for (int j = 0; j < 4; j++) m_rawp4_D0shws_side3_low[m_n_D0shws_side3_low][j] = Gm_p4[j];
                            if (runNo < 0) m_rawp4_D0shws_side3_low[m_n_D0shws_side3_low][4] = MatchMC(pgam, "D0_tag");
                            else m_rawp4_D0shws_side3_low[m_n_D0shws_side3_low][4] = -999;
                            if (runNo < 0) m_rawp4_D0shws_side3_low[m_n_D0shws_side3_low][5] = MatchMC(pgam, "Dm_tag");
                            else m_rawp4_D0shws_side3_low[m_n_D0shws_side3_low][5] = -999;
                            m_vtx_D0shws_side3_low[m_n_D0shws_side3_low][0] = eraw;
                            m_vtx_D0shws_side3_low[m_n_D0shws_side3_low][1] = phi;
                            m_vtx_D0shws_side3_low[m_n_D0shws_side3_low][2] = the;
                            m_vtx_D0shws_side3_low[m_n_D0shws_side3_low][3] = dang;
                            m_vtx_D0shws_side3_low[m_n_D0shws_side3_low][4] = module;
                            m_vtx_D0shws_side3_low[m_n_D0shws_side3_low][5] = Tdc;
                            m_n_D0shws_side3_low++;
                        }
                        if (m_sample_types[mm] == "side3_up") {
                            for (int j = 0; j < 4; j++) m_rawp4_D0shws_side3_up[m_n_D0shws_side3_up][j] = Gm_p4[j];
                            if (runNo < 0) m_rawp4_D0shws_side3_up[m_n_D0shws_side3_up][4] = MatchMC(pgam, "D0_tag");
                            else m_rawp4_D0shws_side3_up[m_n_D0shws_side3_up][4] = -999;
                            if (runNo < 0) m_rawp4_D0shws_side3_up[m_n_D0shws_side3_up][5] = MatchMC(pgam, "Dm_tag");
                            else m_rawp4_D0shws_side3_up[m_n_D0shws_side3_up][5] = -999;
                            m_vtx_D0shws_side3_up[m_n_D0shws_side3_up][0] = eraw;
                            m_vtx_D0shws_side3_up[m_n_D0shws_side3_up][1] = phi;
                            m_vtx_D0shws_side3_up[m_n_D0shws_side3_up][2] = the;
                            m_vtx_D0shws_side3_up[m_n_D0shws_side3_up][3] = dang;
                            m_vtx_D0shws_side3_up[m_n_D0shws_side3_up][4] = module;
                            m_vtx_D0shws_side3_up[m_n_D0shws_side3_up][5] = Tdc;
                            m_n_D0shws_side3_up++;
                        }
                        if (m_sample_types[mm] == "side4_low") {
                            for (int j = 0; j < 4; j++) m_rawp4_D0shws_side4_low[m_n_D0shws_side4_low][j] = Gm_p4[j];
                            if (runNo < 0) m_rawp4_D0shws_side4_low[m_n_D0shws_side4_low][4] = MatchMC(pgam, "D0_tag");
                            else m_rawp4_D0shws_side4_low[m_n_D0shws_side4_low][4] = -999;
                            if (runNo < 0) m_rawp4_D0shws_side4_low[m_n_D0shws_side4_low][5] = MatchMC(pgam, "Dm_tag");
                            else m_rawp4_D0shws_side4_low[m_n_D0shws_side4_low][5] = -999;
                            m_vtx_D0shws_side4_low[m_n_D0shws_side4_low][0] = eraw;
                            m_vtx_D0shws_side4_low[m_n_D0shws_side4_low][1] = phi;
                            m_vtx_D0shws_side4_low[m_n_D0shws_side4_low][2] = the;
                            m_vtx_D0shws_side4_low[m_n_D0shws_side4_low][3] = dang;
                            m_vtx_D0shws_side4_low[m_n_D0shws_side4_low][4] = module;
                            m_vtx_D0shws_side4_low[m_n_D0shws_side4_low][5] = Tdc;
                            m_n_D0shws_side4_low++;
                        }
                        if (m_sample_types[mm] == "side4_up") {
                            for (int j = 0; j < 4; j++) m_rawp4_D0shws_side4_up[m_n_D0shws_side4_up][j] = Gm_p4[j];
                            if (runNo < 0) m_rawp4_D0shws_side4_up[m_n_D0shws_side4_up][4] = MatchMC(pgam, "D0_tag");
                            else m_rawp4_D0shws_side4_up[m_n_D0shws_side4_up][4] = -999;
                            if (runNo < 0) m_rawp4_D0shws_side4_up[m_n_D0shws_side4_up][5] = MatchMC(pgam, "Dm_tag");
                            else m_rawp4_D0shws_side4_up[m_n_D0shws_side4_up][5] = -999;
                            m_vtx_D0shws_side4_up[m_n_D0shws_side4_up][0] = eraw;
                            m_vtx_D0shws_side4_up[m_n_D0shws_side4_up][1] = phi;
                            m_vtx_D0shws_side4_up[m_n_D0shws_side4_up][2] = the;
                            m_vtx_D0shws_side4_up[m_n_D0shws_side4_up][3] = dang;
                            m_vtx_D0shws_side4_up[m_n_D0shws_side4_up][4] = module;
                            m_vtx_D0shws_side4_up[m_n_D0shws_side4_up][5] = Tdc;
                            m_n_D0shws_side4_up++;
                        }
                    }
                    // Tracks of secound D
                    ...
                    if (m_sample_types[mm] == "signal") m_n_Dmshws_signal = 0;
                    if (m_sample_types[mm] == "side1_low") m_n_Dmshws_side1_low = 0;
                    if (m_sample_types[mm] == "side1_up") m_n_Dmshws_side1_up = 0;
                    if (m_sample_types[mm] == "side2_low") m_n_Dmshws_side2_low = 0;
                    if (m_sample_types[mm] == "side2_up") m_n_Dmshws_side2_up = 0;
                    if (m_sample_types[mm] == "side3_low") m_n_Dmshws_side3_low = 0;
                    if (m_sample_types[mm] == "side3_up") m_n_Dmshws_side3_up = 0;
                    if (m_sample_types[mm] == "side4_low") m_n_Dmshws_side4_low = 0;
                    if (m_sample_types[mm] == "side4_up") m_n_Dmshws_side4_up = 0;
                    for (int i = 0; i < Showers2.size(); i++) {
                        ...
                        double Tdc = gamShower->time();
                        if (m_sample_types[mm] == "signal") {
                            for (int j = 0; j < 4; j++) m_rawp4_Dmshws_signal[m_n_Dmshws_signal][j] = Gm_p4[j];
                            if (runNo < 0) m_rawp4_Dmshws_signal[m_n_Dmshws_signal][4] = MatchMC(pgam, "Dm_tag");
                            else m_rawp4_Dmshws_signal[m_n_Dmshws_signal][4] = -999;
                            if (runNo < 0) m_rawp4_Dmshws_signal[m_n_Dmshws_signal][5] = MatchMC(pgam, "D0_tag");
                            else m_rawp4_Dmshws_signal[m_n_Dmshws_signal][5] = -999;
                            m_vtx_Dmshws_signal[m_n_Dmshws_signal][0] = eraw;
                            m_vtx_Dmshws_signal[m_n_Dmshws_signal][1] = phi;
                            m_vtx_Dmshws_signal[m_n_Dmshws_signal][2] = the;
                            m_vtx_Dmshws_signal[m_n_Dmshws_signal][3] = dang;
                            m_vtx_Dmshws_signal[m_n_Dmshws_signal][4] = module;
                            m_vtx_Dmshws_signal[m_n_Dmshws_signal][5] = Tdc;
                            m_n_Dmshws_signal++;
                        }
                        if (m_sample_types[mm] == "side1_low") {
                            for (int j = 0; j < 4; j++) m_rawp4_Dmshws_side1_low[m_n_Dmshws_side1_low][j] = Gm_p4[j];
                            if (runNo < 0) m_rawp4_Dmshws_side1_low[m_n_Dmshws_side1_low][4] = MatchMC(pgam, "Dm_tag");
                            else m_rawp4_Dmshws_side1_low[m_n_Dmshws_side1_low][4] = -999;
                            if (runNo < 0) m_rawp4_Dmshws_side1_low[m_n_Dmshws_side1_low][5] = MatchMC(pgam, "D0_tag");
                            else m_rawp4_Dmshws_side1_low[m_n_Dmshws_side1_low][5] = -999;
                            m_vtx_Dmshws_side1_low[m_n_Dmshws_side1_low][0] = eraw;
                            m_vtx_Dmshws_side1_low[m_n_Dmshws_side1_low][1] = phi;
                            m_vtx_Dmshws_side1_low[m_n_Dmshws_side1_low][2] = the;
                            m_vtx_Dmshws_side1_low[m_n_Dmshws_side1_low][3] = dang;
                            m_vtx_Dmshws_side1_low[m_n_Dmshws_side1_low][4] = module;
                            m_vtx_Dmshws_side1_low[m_n_Dmshws_side1_low][5] = Tdc;
                            m_n_Dmshws_side1_low++;
                        }
                        if (m_sample_types[mm] == "side1_up") {
                            for (int j = 0; j < 4; j++) m_rawp4_Dmshws_side1_up[m_n_Dmshws_side1_up][j] = Gm_p4[j];
                            if (runNo < 0) m_rawp4_Dmshws_side1_up[m_n_Dmshws_side1_up][4] = MatchMC(pgam, "Dm_tag");
                            else m_rawp4_Dmshws_side1_up[m_n_Dmshws_side1_up][4] = -999;
                            if (runNo < 0) m_rawp4_Dmshws_side1_up[m_n_Dmshws_side1_up][5] = MatchMC(pgam, "D0_tag");
                            else m_rawp4_Dmshws_side1_up[m_n_Dmshws_side1_up][5] = -999;
                            m_vtx_Dmshws_side1_up[m_n_Dmshws_side1_up][0] = eraw;
                            m_vtx_Dmshws_side1_up[m_n_Dmshws_side1_up][1] = phi;
                            m_vtx_Dmshws_side1_up[m_n_Dmshws_side1_up][2] = the;
                            m_vtx_Dmshws_side1_up[m_n_Dmshws_side1_up][3] = dang;
                            m_vtx_Dmshws_side1_up[m_n_Dmshws_side1_up][4] = module;
                            m_vtx_Dmshws_side1_up[m_n_Dmshws_side1_up][5] = Tdc;
                            m_n_Dmshws_side1_up++;
                        }
                        if (m_sample_types[mm] == "side2_low") {
                            for (int j = 0; j < 4; j++) m_rawp4_Dmshws_side2_low[m_n_Dmshws_side2_low][j] = Gm_p4[j];
                            if (runNo < 0) m_rawp4_Dmshws_side2_low[m_n_Dmshws_side2_low][4] = MatchMC(pgam, "Dm_tag");
                            else m_rawp4_Dmshws_side2_low[m_n_Dmshws_side2_low][4] = -999;
                            if (runNo < 0) m_rawp4_Dmshws_side2_low[m_n_Dmshws_side2_low][5] = MatchMC(pgam, "D0_tag");
                            else m_rawp4_Dmshws_side2_low[m_n_Dmshws_side2_low][5] = -999;
                            m_vtx_Dmshws_side2_low[m_n_Dmshws_side2_low][0] = eraw;
                            m_vtx_Dmshws_side2_low[m_n_Dmshws_side2_low][1] = phi;
                            m_vtx_Dmshws_side2_low[m_n_Dmshws_side2_low][2] = the;
                            m_vtx_Dmshws_side2_low[m_n_Dmshws_side2_low][3] = dang;
                            m_vtx_Dmshws_side2_low[m_n_Dmshws_side2_low][4] = module;
                            m_vtx_Dmshws_side2_low[m_n_Dmshws_side2_low][5] = Tdc;
                            m_n_Dmshws_side2_low++;
                        }
                        if (m_sample_types[mm] == "side2_up") {
                            for (int j = 0; j < 4; j++) m_rawp4_Dmshws_side2_up[m_n_Dmshws_side2_up][j] = Gm_p4[j];
                            if (runNo < 0) m_rawp4_Dmshws_side2_up[m_n_Dmshws_side2_up][4] = MatchMC(pgam, "Dm_tag");
                            else m_rawp4_Dmshws_side2_up[m_n_Dmshws_side2_up][4] = -999;
                            if (runNo < 0) m_rawp4_Dmshws_side2_up[m_n_Dmshws_side2_up][5] = MatchMC(pgam, "D0_tag");
                            else m_rawp4_Dmshws_side2_up[m_n_Dmshws_side2_up][5] = -999;
                            m_vtx_Dmshws_side2_up[m_n_Dmshws_side2_up][0] = eraw;
                            m_vtx_Dmshws_side2_up[m_n_Dmshws_side2_up][1] = phi;
                            m_vtx_Dmshws_side2_up[m_n_Dmshws_side2_up][2] = the;
                            m_vtx_Dmshws_side2_up[m_n_Dmshws_side2_up][3] = dang;
                            m_vtx_Dmshws_side2_up[m_n_Dmshws_side2_up][4] = module;
                            m_vtx_Dmshws_side2_up[m_n_Dmshws_side2_up][5] = Tdc;
                            m_n_Dmshws_side2_up++;
                        }
                        if (m_sample_types[mm] == "side3_low") {
                            for (int j = 0; j < 4; j++) m_rawp4_Dmshws_side3_low[m_n_Dmshws_side3_low][j] = Gm_p4[j];
                            if (runNo < 0) m_rawp4_Dmshws_side3_low[m_n_Dmshws_side3_low][4] = MatchMC(pgam, "Dm_tag");
                            else m_rawp4_Dmshws_side3_low[m_n_Dmshws_side3_low][4] = -999;
                            if (runNo < 0) m_rawp4_Dmshws_side3_low[m_n_Dmshws_side3_low][5] = MatchMC(pgam, "D0_tag");
                            else m_rawp4_Dmshws_side3_low[m_n_Dmshws_side3_low][5] = -999;
                            m_vtx_Dmshws_side3_low[m_n_Dmshws_side3_low][0] = eraw;
                            m_vtx_Dmshws_side3_low[m_n_Dmshws_side3_low][1] = phi;
                            m_vtx_Dmshws_side3_low[m_n_Dmshws_side3_low][2] = the;
                            m_vtx_Dmshws_side3_low[m_n_Dmshws_side3_low][3] = dang;
                            m_vtx_Dmshws_side3_low[m_n_Dmshws_side3_low][4] = module;
                            m_vtx_Dmshws_side3_low[m_n_Dmshws_side3_low][5] = Tdc;
                            m_n_Dmshws_side3_low++;
                        }
                        if (m_sample_types[mm] == "side3_up") {
                            for (int j = 0; j < 4; j++) m_rawp4_Dmshws_side3_up[m_n_Dmshws_side3_up][j] = Gm_p4[j];
                            if (runNo < 0) m_rawp4_Dmshws_side3_up[m_n_Dmshws_side3_up][4] = MatchMC(pgam, "Dm_tag");
                            else m_rawp4_Dmshws_side3_up[m_n_Dmshws_side3_up][4] = -999;
                            if (runNo < 0) m_rawp4_Dmshws_side3_up[m_n_Dmshws_side3_up][5] = MatchMC(pgam, "D0_tag");
                            else m_rawp4_Dmshws_side3_up[m_n_Dmshws_side3_up][5] = -999;
                            m_vtx_Dmshws_side3_up[m_n_Dmshws_side3_up][0] = eraw;
                            m_vtx_Dmshws_side3_up[m_n_Dmshws_side3_up][1] = phi;
                            m_vtx_Dmshws_side3_up[m_n_Dmshws_side3_up][2] = the;
                            m_vtx_Dmshws_side3_up[m_n_Dmshws_side3_up][3] = dang;
                            m_vtx_Dmshws_side3_up[m_n_Dmshws_side3_up][4] = module;
                            m_vtx_Dmshws_side3_up[m_n_Dmshws_side3_up][5] = Tdc;
                            m_n_Dmshws_side3_up++;
                        }
                        if (m_sample_types[mm] == "side4_low") {
                            for (int j = 0; j < 4; j++) m_rawp4_Dmshws_side4_low[m_n_Dmshws_side4_low][j] = Gm_p4[j];
                            if (runNo < 0) m_rawp4_Dmshws_side4_low[m_n_Dmshws_side4_low][4] = MatchMC(pgam, "Dm_tag");
                            else m_rawp4_Dmshws_side4_low[m_n_Dmshws_side4_low][4] = -999;
                            if (runNo < 0) m_rawp4_Dmshws_side4_low[m_n_Dmshws_side4_low][5] = MatchMC(pgam, "D0_tag");
                            else m_rawp4_Dmshws_side4_low[m_n_Dmshws_side4_low][5] = -999;
                            m_vtx_Dmshws_side4_low[m_n_Dmshws_side4_low][0] = eraw;
                            m_vtx_Dmshws_side4_low[m_n_Dmshws_side4_low][1] = phi;
                            m_vtx_Dmshws_side4_low[m_n_Dmshws_side4_low][2] = the;
                            m_vtx_Dmshws_side4_low[m_n_Dmshws_side4_low][3] = dang;
                            m_vtx_Dmshws_side4_low[m_n_Dmshws_side4_low][4] = module;
                            m_vtx_Dmshws_side4_low[m_n_Dmshws_side4_low][5] = Tdc;
                            m_n_Dmshws_side4_low++;
                        }
                        if (m_sample_types[mm] == "side4_up") {
                            for (int j = 0; j < 4; j++) m_rawp4_Dmshws_side4_up[m_n_Dmshws_side4_up][j] = Gm_p4[j];
                            if (runNo < 0) m_rawp4_Dmshws_side4_up[m_n_Dmshws_side4_up][4] = MatchMC(pgam, "Dm_tag");
                            else m_rawp4_Dmshws_side4_up[m_n_Dmshws_side4_up][4] = -999;
                            if (runNo < 0) m_rawp4_Dmshws_side4_up[m_n_Dmshws_side4_up][5] = MatchMC(pgam, "D0_tag");
                            else m_rawp4_Dmshws_side4_up[m_n_Dmshws_side4_up][5] = -999;
                            m_vtx_Dmshws_side4_up[m_n_Dmshws_side4_up][0] = eraw;
                            m_vtx_Dmshws_side4_up[m_n_Dmshws_side4_up][1] = phi;
                            m_vtx_Dmshws_side4_up[m_n_Dmshws_side4_up][2] = the;
                            m_vtx_Dmshws_side4_up[m_n_Dmshws_side4_up][3] = dang;
                            m_vtx_Dmshws_side4_up[m_n_Dmshws_side4_up][4] = module;
                            m_vtx_Dmshws_side4_up[m_n_Dmshws_side4_up][5] = Tdc;
                            m_n_Dmshws_side4_up++;
                        }
                    }
                    // The pion out of D 
                    ...
                    for (int i = 0; i < Tracks1.size(); i++) {
                        ...
                        if (m_sample_types[mm] == "signal") for (int j = 0; j < 4; j++) m_p4_D0trks_4c_signal[i][j] = kmfit->pfit(i)[j];
                        if (m_sample_types[mm] == "side1_low") for (int j = 0; j < 4; j++) m_p4_D0trks_4c_side1_low[i][j] = kmfit->pfit(i)[j];
                        if (m_sample_types[mm] == "side1_up") for (int j = 0; j < 4; j++) m_p4_D0trks_4c_side1_up[i][j] = kmfit->pfit(i)[j];
                        if (m_sample_types[mm] == "side2_low") for (int j = 0; j < 4; j++) m_p4_D0trks_4c_side2_low[i][j] = kmfit->pfit(i)[j];
                        if (m_sample_types[mm] == "side2_up") for (int j = 0; j < 4; j++) m_p4_D0trks_4c_side2_up[i][j] = kmfit->pfit(i)[j];
                        if (m_sample_types[mm] == "side3_low") for (int j = 0; j < 4; j++) m_p4_D0trks_4c_side3_low[i][j] = kmfit->pfit(i)[j];
                        if (m_sample_types[mm] == "side3_up") for (int j = 0; j < 4; j++) m_p4_D0trks_4c_side3_up[i][j] = kmfit->pfit(i)[j];
                        if (m_sample_types[mm] == "side4_low") for (int j = 0; j < 4; j++) m_p4_D0trks_4c_side4_low[i][j] = kmfit->pfit(i)[j];
                        if (m_sample_types[mm] == "side4_up") for (int j = 0; j < 4; j++) m_p4_D0trks_4c_side4_up[i][j] = kmfit->pfit(i)[j];
                    }
                    for (int i = 0; i < Showers1.size(); i++) {
                        kD0p4_4c += kmfit->pfit(i + Tracks1.size());
                        if (m_sample_types[mm] == "signal") for (int j = 0; j < 4; j++) m_p4_D0shws_4c_signal[i][j] = kmfit->pfit(i + Tracks1.size())[j];
                        if (m_sample_types[mm] == "side1_low") for (int j = 0; j < 4; j++) m_p4_D0shws_4c_side1_low[i][j] = kmfit->pfit(i + Tracks1.size())[j];
                        if (m_sample_types[mm] == "side1_up") for (int j = 0; j < 4; j++) m_p4_D0shws_4c_side1_up[i][j] = kmfit->pfit(i + Tracks1.size())[j];
                        if (m_sample_types[mm] == "side2_low") for (int j = 0; j < 4; j++) m_p4_D0shws_4c_side2_low[i][j] = kmfit->pfit(i + Tracks1.size())[j];
                        if (m_sample_types[mm] == "side2_up") for (int j = 0; j < 4; j++) m_p4_D0shws_4c_side2_up[i][j] = kmfit->pfit(i + Tracks1.size())[j];
                        if (m_sample_types[mm] == "side3_low") for (int j = 0; j < 4; j++) m_p4_D0shws_4c_side3_low[i][j] = kmfit->pfit(i + Tracks1.size())[j];
                        if (m_sample_types[mm] == "side3_up") for (int j = 0; j < 4; j++) m_p4_D0shws_4c_side3_up[i][j] = kmfit->pfit(i + Tracks1.size())[j];
                        if (m_sample_types[mm] == "side4_low") for (int j = 0; j < 4; j++) m_p4_D0shws_4c_side4_low[i][j] = kmfit->pfit(i + Tracks1.size())[j];
                        if (m_sample_types[mm] == "side4_up") for (int j = 0; j < 4; j++) m_p4_D0shws_4c_side4_up[i][j] = kmfit->pfit(i + Tracks1.size())[j];
                    }
                    HepLorentzVector kDmp4_4c = 0;
                    for (int i = 0; i < Tracks2.size(); i++) {
                        kDmp4_4c += kmfit->pfit(i + Tracks1.size() + Showers1.size());
                        if (m_sample_types[mm] == "signal") for (int j = 0; j < 4; j++) m_p4_Dmtrks_4c_signal[i][j] = kmfit->pfit(i + Tracks1.size() + Showers1.size())[j];
                        if (m_sample_types[mm] == "side1_low") for (int j = 0; j < 4; j++) m_p4_Dmtrks_4c_side1_low[i][j] = kmfit->pfit(i + Tracks1.size() + Showers1.size())[j];
                        if (m_sample_types[mm] == "side1_up") for (int j = 0; j < 4; j++) m_p4_Dmtrks_4c_side1_up[i][j] = kmfit->pfit(i + Tracks1.size() + Showers1.size())[j];
                        if (m_sample_types[mm] == "side2_low") for (int j = 0; j < 4; j++) m_p4_Dmtrks_4c_side2_low[i][j] = kmfit->pfit(i + Tracks1.size() + Showers1.size())[j];
                        if (m_sample_types[mm] == "side2_up") for (int j = 0; j < 4; j++) m_p4_Dmtrks_4c_side2_up[i][j] = kmfit->pfit(i + Tracks1.size() + Showers1.size())[j];
                        if (m_sample_types[mm] == "side3_up") for (int j = 0; j < 4; j++) m_p4_Dmtrks_4c_side3_up[i][j] = kmfit->pfit(i + Tracks1.size() + Showers1.size())[j];
                        if (m_sample_types[mm] == "side3_low") for (int j = 0; j < 4; j++) m_p4_Dmtrks_4c_side3_low[i][j] = kmfit->pfit(i + Tracks1.size() + Showers1.size())[j];
                        if (m_sample_types[mm] == "side4_up") for (int j = 0; j < 4; j++) m_p4_Dmtrks_4c_side4_up[i][j] = kmfit->pfit(i + Tracks1.size() + Showers1.size())[j];
                        if (m_sample_types[mm] == "side4_low") for (int j = 0; j < 4; j++) m_p4_Dmtrks_4c_side4_low[i][j] = kmfit->pfit(i + Tracks1.size() + Showers1.size())[j];
                    }
                    for (int i = 0; i < Showers2.size(); i++) {
                        kDmp4_4c += kmfit->pfit(i + Tracks1.size() + Showers1.size() + Tracks2.size());
                        if (m_sample_types[mm] == "signal") for (int j = 0; j < 4; j++) m_p4_Dmshws_4c_signal[i][j] = kmfit->pfit(i + Tracks1.size() + Showers1.size() + Tracks2.size())[j];
                        if (m_sample_types[mm] == "side1_low") for (int j = 0; j < 4; j++) m_p4_Dmshws_4c_side1_low[i][j] = kmfit->pfit(i + Tracks1.size() + Showers1.size() + Tracks2.size())[j];
                        if (m_sample_types[mm] == "side1_up") for (int j = 0; j < 4; j++) m_p4_Dmshws_4c_side1_up[i][j] = kmfit->pfit(i + Tracks1.size() + Showers1.size() + Tracks2.size())[j];
                        if (m_sample_types[mm] == "side2_low") for (int j = 0; j < 4; j++) m_p4_Dmshws_4c_side2_low[i][j] = kmfit->pfit(i + Tracks1.size() + Showers1.size() + Tracks2.size())[j];
                        if (m_sample_types[mm] == "side2_up") for (int j = 0; j < 4; j++) m_p4_Dmshws_4c_side2_up[i][j] = kmfit->pfit(i + Tracks1.size() + Showers1.size() + Tracks2.size())[j];
                        if (m_sample_types[mm] == "side3_up") for (int j = 0; j < 4; j++) m_p4_Dmshws_4c_side3_up[i][j] = kmfit->pfit(i + Tracks1.size() + Showers1.size() + Tracks2.size())[j];
                        if (m_sample_types[mm] == "side3_low") for (int j = 0; j < 4; j++) m_p4_Dmshws_4c_side3_low[i][j] = kmfit->pfit(i + Tracks1.size() + Showers1.size() + Tracks2.size())[j];
                        if (m_sample_types[mm] == "side4_up") for (int j = 0; j < 4; j++) m_p4_Dmshws_4c_side4_up[i][j] = kmfit->pfit(i + Tracks1.size() + Showers1.size() + Tracks2.size())[j];
                        if (m_sample_types[mm] == "side4_low") for (int j = 0; j < 4; j++) m_p4_Dmshws_4c_side4_low[i][j] = kmfit->pfit(i + Tracks1.size() + Showers1.size() + Tracks2.size())[j];
                    }
                    ...
                    if (m_sample_types[mm] == "signal") {
                        m_D0_mode_signal          = besttag1->decayMode();
                        m_D0_type_signal          = besttag1->type();
                        m_D0_dcharge_signal       = besttag1->charge();
                        m_D0_charm_signal         = besttag1->charm();
                        m_D0_numofchildren_signal = besttag1->numOfChildren();
                        m_D0_be_signal            = besttag1->beamE();
                        m_D0_mass_signal          = besttag1->mass();
                        m_D0_mBC_signal           = besttag1->mBC();
                        m_D0_deltae_signal        = besttag1->deltaE();
                        m_Dm_mode_signal          = besttag2->decayMode();
                        m_Dm_type_signal          = besttag2->type();
                        m_Dm_dcharge_signal       = besttag2->charge();
                        m_Dm_charm_signal         = besttag2->charm();
                        m_Dm_numofchildren_signal = besttag2->numOfChildren();
                        m_Dm_be_signal            = besttag2->beamE();
                        m_Dm_mass_signal          = besttag2->mass();
                        m_Dm_mBC_signal           = besttag2->mBC();
                        m_Dm_deltae_signal        = besttag2->deltaE();
                        m_chisq_4c_signal = CHISQ;
	                    m_p4_D0_4c_signal[0] = besKD0p4.px();
                        m_p4_D0_4c_signal[1] = besKD0p4.py();
                        m_p4_D0_4c_signal[2] = besKD0p4.pz();
                        m_p4_D0_4c_signal[3] = besKD0p4.e();
                        m_p4_Dm_4c_signal[0] = besKDmp4.px();
                        m_p4_Dm_4c_signal[1] = besKDmp4.py();
                        m_p4_Dm_4c_signal[2] = besKDmp4.pz();
                        m_p4_Dm_4c_signal[3] = besKDmp4.e();
                        m_p4_pip_4c_signal[0] = besKpipp4.px();
                        m_p4_pip_4c_signal[1] = besKpipp4.py();
                        m_p4_pip_4c_signal[2] = besKpipp4.pz();
                        m_p4_pip_4c_signal[3] = besKpipp4.e();
                    }
                    if (m_sample_types[mm] == "side1_low") {
                        m_D0_mode_side1_low          = besttag1->decayMode();
                        m_D0_type_side1_low          = besttag1->type();
                        m_D0_dcharge_side1_low       = besttag1->charge();
                        m_D0_charm_side1_low         = besttag1->charm();
                        m_D0_numofchildren_side1_low = besttag1->numOfChildren();
                        m_D0_be_side1_low            = besttag1->beamE();
                        m_D0_mass_side1_low          = besttag1->mass();
                        m_D0_mBC_side1_low           = besttag1->mBC();
                        m_D0_deltae_side1_low        = besttag1->deltaE();
                        m_Dm_mode_side1_low          = besttag2->decayMode();
                        m_Dm_type_side1_low          = besttag2->type();
                        m_Dm_dcharge_side1_low       = besttag2->charge();
                        m_Dm_charm_side1_low         = besttag2->charm();
                        m_Dm_numofchildren_side1_low = besttag2->numOfChildren();
                        m_Dm_be_side1_low            = besttag2->beamE();
                        m_Dm_mass_side1_low          = besttag2->mass();
                        m_Dm_mBC_side1_low           = besttag2->mBC();
                        m_Dm_deltae_side1_low        = besttag2->deltaE();
                        m_chisq_4c_side1_low = CHISQ;
	                    m_p4_D0_4c_side1_low[0] = besKD0p4.px();
                        m_p4_D0_4c_side1_low[1] = besKD0p4.py();
                        m_p4_D0_4c_side1_low[2] = besKD0p4.pz();
                        m_p4_D0_4c_side1_low[3] = besKD0p4.e();
                        m_p4_Dm_4c_side1_low[0] = besKDmp4.px();
                        m_p4_Dm_4c_side1_low[1] = besKDmp4.py();
                        m_p4_Dm_4c_side1_low[2] = besKDmp4.pz();
                        m_p4_Dm_4c_side1_low[3] = besKDmp4.e();
                        m_p4_pip_4c_side1_low[0] = besKpipp4.px();
                        m_p4_pip_4c_side1_low[1] = besKpipp4.py();
                        m_p4_pip_4c_side1_low[2] = besKpipp4.pz();
                        m_p4_pip_4c_side1_low[3] = besKpipp4.e();
                    }
                    if (m_sample_types[mm] == "side1_up") {
                        m_D0_mode_side1_up          = besttag1->decayMode();
                        m_D0_type_side1_up          = besttag1->type();
                        m_D0_dcharge_side1_up       = besttag1->charge();
                        m_D0_charm_side1_up         = besttag1->charm();
                        m_D0_numofchildren_side1_up = besttag1->numOfChildren();
                        m_D0_be_side1_up            = besttag1->beamE();
                        m_D0_mass_side1_up          = besttag1->mass();
                        m_D0_mBC_side1_up           = besttag1->mBC();
                        m_D0_deltae_side1_up        = besttag1->deltaE();
                        m_Dm_mode_side1_up          = besttag2->decayMode();
                        m_Dm_type_side1_up          = besttag2->type();
                        m_Dm_dcharge_side1_up       = besttag2->charge();
                        m_Dm_charm_side1_up         = besttag2->charm();
                        m_Dm_numofchildren_side1_up = besttag2->numOfChildren();
                        m_Dm_be_side1_up            = besttag2->beamE();
                        m_Dm_mass_side1_up          = besttag2->mass();
                        m_Dm_mBC_side1_up           = besttag2->mBC();
                        m_Dm_deltae_side1_up        = besttag2->deltaE();
                        m_chisq_4c_side1_up = CHISQ;
	                    m_p4_D0_4c_side1_up[0] = besKD0p4.px();
                        m_p4_D0_4c_side1_up[1] = besKD0p4.py();
                        m_p4_D0_4c_side1_up[2] = besKD0p4.pz();
                        m_p4_D0_4c_side1_up[3] = besKD0p4.e();
                        m_p4_Dm_4c_side1_up[0] = besKDmp4.px();
                        m_p4_Dm_4c_side1_up[1] = besKDmp4.py();
                        m_p4_Dm_4c_side1_up[2] = besKDmp4.pz();
                        m_p4_Dm_4c_side1_up[3] = besKDmp4.e();
                        m_p4_pip_4c_side1_up[0] = besKpipp4.px();
                        m_p4_pip_4c_side1_up[1] = besKpipp4.py();
                        m_p4_pip_4c_side1_up[2] = besKpipp4.pz();
                        m_p4_pip_4c_side1_up[3] = besKpipp4.e();
                    }
                    if (m_sample_types[mm] == "side2_low") {
                        m_D0_mode_side2_low          = besttag1->decayMode();
                        m_D0_type_side2_low          = besttag1->type();
                        m_D0_dcharge_side2_low       = besttag1->charge();
                        m_D0_charm_side2_low         = besttag1->charm();
                        m_D0_numofchildren_side2_low = besttag1->numOfChildren();
                        m_D0_be_side2_low            = besttag1->beamE();
                        m_D0_mass_side2_low          = besttag1->mass();
                        m_D0_mBC_side2_low           = besttag1->mBC();
                        m_D0_deltae_side2_low        = besttag1->deltaE();
                        m_Dm_mode_side2_low          = besttag2->decayMode();
                        m_Dm_type_side2_low          = besttag2->type();
                        m_Dm_dcharge_side2_low       = besttag2->charge();
                        m_Dm_charm_side2_low         = besttag2->charm();
                        m_Dm_numofchildren_side2_low = besttag2->numOfChildren();
                        m_Dm_be_side2_low            = besttag2->beamE();
                        m_Dm_mass_side2_low          = besttag2->mass();
                        m_Dm_mBC_side2_low           = besttag2->mBC();
                        m_Dm_deltae_side2_low        = besttag2->deltaE();
                        m_chisq_4c_side2_low = CHISQ;
	                    m_p4_D0_4c_side2_low[0] = besKD0p4.px();
                        m_p4_D0_4c_side2_low[1] = besKD0p4.py();
                        m_p4_D0_4c_side2_low[2] = besKD0p4.pz();
                        m_p4_D0_4c_side2_low[3] = besKD0p4.e();
                        m_p4_Dm_4c_side2_low[0] = besKDmp4.px();
                        m_p4_Dm_4c_side2_low[1] = besKDmp4.py();
                        m_p4_Dm_4c_side2_low[2] = besKDmp4.pz();
                        m_p4_Dm_4c_side2_low[3] = besKDmp4.e();
                        m_p4_pip_4c_side2_low[0] = besKpipp4.px();
                        m_p4_pip_4c_side2_low[1] = besKpipp4.py();
                        m_p4_pip_4c_side2_low[2] = besKpipp4.pz();
                        m_p4_pip_4c_side2_low[3] = besKpipp4.e();
                    }
                    if (m_sample_types[mm] == "side2_up") {
                        m_D0_mode_side2_up          = besttag1->decayMode();
                        m_D0_type_side2_up          = besttag1->type();
                        m_D0_dcharge_side2_up       = besttag1->charge();
                        m_D0_charm_side2_up         = besttag1->charm();
                        m_D0_numofchildren_side2_up = besttag1->numOfChildren();
                        m_D0_be_side2_up            = besttag1->beamE();
                        m_D0_mass_side2_up          = besttag1->mass();
                        m_D0_mBC_side2_up           = besttag1->mBC();
                        m_D0_deltae_side2_up        = besttag1->deltaE();
                        m_Dm_mode_side2_up          = besttag2->decayMode();
                        m_Dm_type_side2_up          = besttag2->type();
                        m_Dm_dcharge_side2_up       = besttag2->charge();
                        m_Dm_charm_side2_up         = besttag2->charm();
                        m_Dm_numofchildren_side2_up = besttag2->numOfChildren();
                        m_Dm_be_side2_up            = besttag2->beamE();
                        m_Dm_mass_side2_up          = besttag2->mass();
                        m_Dm_mBC_side2_up           = besttag2->mBC();
                        m_Dm_deltae_side2_up        = besttag2->deltaE();
                        m_chisq_4c_side2_up = CHISQ;
	                    m_p4_D0_4c_side2_up[0] = besKD0p4.px();
                        m_p4_D0_4c_side2_up[1] = besKD0p4.py();
                        m_p4_D0_4c_side2_up[2] = besKD0p4.pz();
                        m_p4_D0_4c_side2_up[3] = besKD0p4.e();
                        m_p4_Dm_4c_side2_up[0] = besKDmp4.px();
                        m_p4_Dm_4c_side2_up[1] = besKDmp4.py();
                        m_p4_Dm_4c_side2_up[2] = besKDmp4.pz();
                        m_p4_Dm_4c_side2_up[3] = besKDmp4.e();
                        m_p4_pip_4c_side2_up[0] = besKpipp4.px();
                        m_p4_pip_4c_side2_up[1] = besKpipp4.py();
                        m_p4_pip_4c_side2_up[2] = besKpipp4.pz();
                        m_p4_pip_4c_side2_up[3] = besKpipp4.e();
                    }
                    if (m_sample_types[mm] == "side3_low") {
                        m_D0_mode_side3_low          = besttag1->decayMode();
                        m_D0_type_side3_low          = besttag1->type();
                        m_D0_dcharge_side3_low       = besttag1->charge();
                        m_D0_charm_side3_low         = besttag1->charm();
                        m_D0_numofchildren_side3_low = besttag1->numOfChildren();
                        m_D0_be_side3_low            = besttag1->beamE();
                        m_D0_mass_side3_low          = besttag1->mass();
                        m_D0_mBC_side3_low           = besttag1->mBC();
                        m_D0_deltae_side3_low        = besttag1->deltaE();
                        m_Dm_mode_side3_low          = besttag2->decayMode();
                        m_Dm_type_side3_low          = besttag2->type();
                        m_Dm_dcharge_side3_low       = besttag2->charge();
                        m_Dm_charm_side3_low         = besttag2->charm();
                        m_Dm_numofchildren_side3_low = besttag2->numOfChildren();
                        m_Dm_be_side3_low            = besttag2->beamE();
                        m_Dm_mass_side3_low          = besttag2->mass();
                        m_Dm_mBC_side3_low           = besttag2->mBC();
                        m_Dm_deltae_side3_low        = besttag2->deltaE();
                        m_chisq_4c_side3_low = CHISQ;
	                    m_p4_D0_4c_side3_low[0] = besKD0p4.px();
                        m_p4_D0_4c_side3_low[1] = besKD0p4.py();
                        m_p4_D0_4c_side3_low[2] = besKD0p4.pz();
                        m_p4_D0_4c_side3_low[3] = besKD0p4.e();
                        m_p4_Dm_4c_side3_low[0] = besKDmp4.px();
                        m_p4_Dm_4c_side3_low[1] = besKDmp4.py();
                        m_p4_Dm_4c_side3_low[2] = besKDmp4.pz();
                        m_p4_Dm_4c_side3_low[3] = besKDmp4.e();
                        m_p4_pip_4c_side3_low[0] = besKpipp4.px();
                        m_p4_pip_4c_side3_low[1] = besKpipp4.py();
                        m_p4_pip_4c_side3_low[2] = besKpipp4.pz();
                        m_p4_pip_4c_side3_low[3] = besKpipp4.e();
                    }
                    if (m_sample_types[mm] == "side3_up") {
                        m_D0_mode_side3_up          = besttag1->decayMode();
                        m_D0_type_side3_up          = besttag1->type();
                        m_D0_dcharge_side3_up       = besttag1->charge();
                        m_D0_charm_side3_up         = besttag1->charm();
                        m_D0_numofchildren_side3_up = besttag1->numOfChildren();
                        m_D0_be_side3_up            = besttag1->beamE();
                        m_D0_mass_side3_up          = besttag1->mass();
                        m_D0_mBC_side3_up           = besttag1->mBC();
                        m_D0_deltae_side3_up        = besttag1->deltaE();
                        m_Dm_mode_side3_up          = besttag2->decayMode();
                        m_Dm_type_side3_up          = besttag2->type();
                        m_Dm_dcharge_side3_up       = besttag2->charge();
                        m_Dm_charm_side3_up         = besttag2->charm();
                        m_Dm_numofchildren_side3_up = besttag2->numOfChildren();
                        m_Dm_be_side3_up            = besttag2->beamE();
                        m_Dm_mass_side3_up          = besttag2->mass();
                        m_Dm_mBC_side3_up           = besttag2->mBC();
                        m_Dm_deltae_side3_up        = besttag2->deltaE();
                        m_chisq_4c_side3_up = CHISQ;
	                    m_p4_D0_4c_side3_up[0] = besKD0p4.px();
                        m_p4_D0_4c_side3_up[1] = besKD0p4.py();
                        m_p4_D0_4c_side3_up[2] = besKD0p4.pz();
                        m_p4_D0_4c_side3_up[3] = besKD0p4.e();
                        m_p4_Dm_4c_side3_up[0] = besKDmp4.px();
                        m_p4_Dm_4c_side3_up[1] = besKDmp4.py();
                        m_p4_Dm_4c_side3_up[2] = besKDmp4.pz();
                        m_p4_Dm_4c_side3_up[3] = besKDmp4.e();
                        m_p4_pip_4c_side3_up[0] = besKpipp4.px();
                        m_p4_pip_4c_side3_up[1] = besKpipp4.py();
                        m_p4_pip_4c_side3_up[2] = besKpipp4.pz();
                        m_p4_pip_4c_side3_up[3] = besKpipp4.e();
                    }
                    if (m_sample_types[mm] == "side4_low") {
                        m_D0_mode_side4_low          = besttag1->decayMode();
                        m_D0_type_side4_low          = besttag1->type();
                        m_D0_dcharge_side4_low       = besttag1->charge();
                        m_D0_charm_side4_low         = besttag1->charm();
                        m_D0_numofchildren_side4_low = besttag1->numOfChildren();
                        m_D0_be_side4_low            = besttag1->beamE();
                        m_D0_mass_side4_low          = besttag1->mass();
                        m_D0_mBC_side4_low           = besttag1->mBC();
                        m_D0_deltae_side4_low        = besttag1->deltaE();
                        m_Dm_mode_side4_low          = besttag2->decayMode();
                        m_Dm_type_side4_low          = besttag2->type();
                        m_Dm_dcharge_side4_low       = besttag2->charge();
                        m_Dm_charm_side4_low         = besttag2->charm();
                        m_Dm_numofchildren_side4_low = besttag2->numOfChildren();
                        m_Dm_be_side4_low            = besttag2->beamE();
                        m_Dm_mass_side4_low          = besttag2->mass();
                        m_Dm_mBC_side4_low           = besttag2->mBC();
                        m_Dm_deltae_side4_low        = besttag2->deltaE();
                        m_chisq_4c_side4_low = CHISQ;
	                    m_p4_D0_4c_side4_low[0] = besKD0p4.px();
                        m_p4_D0_4c_side4_low[1] = besKD0p4.py();
                        m_p4_D0_4c_side4_low[2] = besKD0p4.pz();
                        m_p4_D0_4c_side4_low[3] = besKD0p4.e();
                        m_p4_Dm_4c_side4_low[0] = besKDmp4.px();
                        m_p4_Dm_4c_side4_low[1] = besKDmp4.py();
                        m_p4_Dm_4c_side4_low[2] = besKDmp4.pz();
                        m_p4_Dm_4c_side4_low[3] = besKDmp4.e();
                        m_p4_pip_4c_side4_low[0] = besKpipp4.px();
                        m_p4_pip_4c_side4_low[1] = besKpipp4.py();
                        m_p4_pip_4c_side4_low[2] = besKpipp4.pz();
                        m_p4_pip_4c_side4_low[3] = besKpipp4.e();
                    }
                    if (m_sample_types[mm] == "side4_up") {
                        m_D0_mode_side4_up          = besttag1->decayMode();
                        m_D0_type_side4_up          = besttag1->type();
                        m_D0_dcharge_side4_up       = besttag1->charge();
                        m_D0_charm_side4_up         = besttag1->charm();
                        m_D0_numofchildren_side4_up = besttag1->numOfChildren();
                        m_D0_be_side4_up            = besttag1->beamE();
                        m_D0_mass_side4_up          = besttag1->mass();
                        m_D0_mBC_side4_up           = besttag1->mBC();
                        m_D0_deltae_side4_up        = besttag1->deltaE();
                        m_Dm_mode_side4_up          = besttag2->decayMode();
                        m_Dm_type_side4_up          = besttag2->type();
                        m_Dm_dcharge_side4_up       = besttag2->charge();
                        m_Dm_charm_side4_up         = besttag2->charm();
                        m_Dm_numofchildren_side4_up = besttag2->numOfChildren();
                        m_Dm_be_side4_up            = besttag2->beamE();
                        m_Dm_mass_side4_up          = besttag2->mass();
                        m_Dm_mBC_side4_up           = besttag2->mBC();
                        m_Dm_deltae_side4_up        = besttag2->deltaE();
                        m_chisq_4c_side4_up = CHISQ;
	                    m_p4_D0_4c_side4_up[0] = besKD0p4.px();
                        m_p4_D0_4c_side4_up[1] = besKD0p4.py();
                        m_p4_D0_4c_side4_up[2] = besKD0p4.pz();
                        m_p4_D0_4c_side4_up[3] = besKD0p4.e();
                        m_p4_Dm_4c_side4_up[0] = besKDmp4.px();
                        m_p4_Dm_4c_side4_up[1] = besKDmp4.py();
                        m_p4_Dm_4c_side4_up[2] = besKDmp4.pz();
                        m_p4_Dm_4c_side4_up[3] = besKDmp4.e();
                        m_p4_pip_4c_side4_up[0] = besKpipp4.px();
                        m_p4_pip_4c_side4_up[1] = besKpipp4.py();
                        m_p4_pip_4c_side4_up[2] = besKpipp4.pz();
                        m_p4_pip_4c_side4_up[3] = besKpipp4.e();
                    }
                    ...
                    // Begain to fill the Kinematic Fitter : signal
                    kmfit->init();
                    // Tracks of first D
                    for (int i = 0; i < tracks1.size(); i++) {
                        RecMdcKalTrack *kapiTrk = tracks1[i]->mdcKalTrack();
                    ...
                    for (int i = 0; i < tracks1.size(); i++) {
                        ...
                        if (m_sample_types[mm] == "signal") for (int j = 0; j < 4; j++) m_p4_D0trks_6c_signal[i][j] = kmfit->pfit(i)[j];
                        if (m_sample_types[mm] == "side1_low") for (int j = 0; j < 4; j++) m_p4_D0trks_6c_side1_low[i][j] = kmfit->pfit(i)[j];
                        if (m_sample_types[mm] == "side1_up") for (int j = 0; j < 4; j++) m_p4_D0trks_6c_side1_up[i][j] = kmfit->pfit(i)[j];
                        if (m_sample_types[mm] == "side2_low") for (int j = 0; j < 4; j++) m_p4_D0trks_6c_side2_low[i][j] = kmfit->pfit(i)[j];
                        if (m_sample_types[mm] == "side2_up") for (int j = 0; j < 4; j++) m_p4_D0trks_6c_side2_up[i][j] = kmfit->pfit(i)[j];
                        if (m_sample_types[mm] == "side3_low") for (int j = 0; j < 4; j++) m_p4_D0trks_6c_side3_low[i][j] = kmfit->pfit(i)[j];
                        if (m_sample_types[mm] == "side3_up") for (int j = 0; j < 4; j++) m_p4_D0trks_6c_side3_up[i][j] = kmfit->pfit(i)[j];
                        if (m_sample_types[mm] == "side4_low") for (int j = 0; j < 4; j++) m_p4_D0trks_6c_side4_low[i][j] = kmfit->pfit(i)[j];
                        if (m_sample_types[mm] == "side4_up") for (int j = 0; j < 4; j++) m_p4_D0trks_6c_side4_up[i][j] = kmfit->pfit(i)[j];
                    }
                    for (int i = 0; i < showers1.size(); i++) {
                        kD0p4_6c += kmfit->pfit(i + tracks1.size());
                        if (m_sample_types[mm] == "signal") for (int j = 0; j < 4; j++) m_p4_D0shws_6c_signal[i][j] = kmfit->pfit(i + tracks1.size())[j];
                        if (m_sample_types[mm] == "side1_low") for (int j = 0; j < 4; j++) m_p4_D0shws_6c_side1_low[i][j] = kmfit->pfit(i + tracks1.size())[j];
                        if (m_sample_types[mm] == "side1_up") for (int j = 0; j < 4; j++) m_p4_D0shws_6c_side1_up[i][j] = kmfit->pfit(i + tracks1.size())[j];
                        if (m_sample_types[mm] == "side2_low") for (int j = 0; j < 4; j++) m_p4_D0shws_6c_side2_low[i][j] = kmfit->pfit(i + tracks1.size())[j];
                        if (m_sample_types[mm] == "side2_up") for (int j = 0; j < 4; j++) m_p4_D0shws_6c_side2_up[i][j] = kmfit->pfit(i + tracks1.size())[j];
                        if (m_sample_types[mm] == "side3_low") for (int j = 0; j < 4; j++) m_p4_D0shws_6c_side3_low[i][j] = kmfit->pfit(i + tracks1.size())[j];
                        if (m_sample_types[mm] == "side3_up") for (int j = 0; j < 4; j++) m_p4_D0shws_6c_side3_up[i][j] = kmfit->pfit(i + tracks1.size())[j];
                        if (m_sample_types[mm] == "side4_low") for (int j = 0; j < 4; j++) m_p4_D0shws_6c_side4_low[i][j] = kmfit->pfit(i + tracks1.size())[j];
                        if (m_sample_types[mm] == "side4_up") for (int j = 0; j < 4; j++) m_p4_D0shws_6c_side4_up[i][j] = kmfit->pfit(i + tracks1.size())[j];
                    }
                    HepLorentzVector kDmp4_6c = 0;
                    for (int i = 0; i < tracks2.size(); i++) {
                        kDmp4_6c += kmfit->pfit(i + tracks1.size() + showers1.size());
                        if (m_sample_types[mm] == "signal") for (int j = 0; j < 4; j++) m_p4_Dmtrks_6c_signal[i][j] = kmfit->pfit(i + tracks1.size() + showers1.size())[j];
                        if (m_sample_types[mm] == "side1_low") for (int j = 0; j < 4; j++) m_p4_Dmtrks_6c_side1_low[i][j] = kmfit->pfit(i + tracks1.size() + showers1.size())[j];
                        if (m_sample_types[mm] == "side1_up") for (int j = 0; j < 4; j++) m_p4_Dmtrks_6c_side1_up[i][j] = kmfit->pfit(i + tracks1.size() + showers1.size())[j];
                        if (m_sample_types[mm] == "side2_low") for (int j = 0; j < 4; j++) m_p4_Dmtrks_6c_side2_low[i][j] = kmfit->pfit(i + tracks1.size() + showers1.size())[j];
                        if (m_sample_types[mm] == "side2_up") for (int j = 0; j < 4; j++) m_p4_Dmtrks_6c_side2_up[i][j] = kmfit->pfit(i + tracks1.size() + showers1.size())[j];
                        if (m_sample_types[mm] == "side3_low") for (int j = 0; j < 4; j++) m_p4_Dmtrks_6c_side3_low[i][j] = kmfit->pfit(i + tracks1.size() + showers1.size())[j];
                        if (m_sample_types[mm] == "side3_up") for (int j = 0; j < 4; j++) m_p4_Dmtrks_6c_side3_up[i][j] = kmfit->pfit(i + tracks1.size() + showers1.size())[j];
                        if (m_sample_types[mm] == "side4_low") for (int j = 0; j < 4; j++) m_p4_Dmtrks_6c_side4_low[i][j] = kmfit->pfit(i + tracks1.size() + showers1.size())[j];
                        if (m_sample_types[mm] == "side4_up") for (int j = 0; j < 4; j++) m_p4_Dmtrks_6c_side4_up[i][j] = kmfit->pfit(i + tracks1.size() + showers1.size())[j];
                    }
                    for (int i = 0; i < showers2.size(); i++) {
                        kDmp4_6c += kmfit->pfit(i + tracks1.size() + showers1.size() + tracks2.size());
                        if (m_sample_types[mm] == "signal") for (int j = 0; j < 4; j++) m_p4_Dmshws_6c_signal[i][j] = kmfit->pfit(i + tracks1.size() + showers1.size() + tracks2.size())[j];
                        if (m_sample_types[mm] == "side1_low") for (int j = 0; j < 4; j++) m_p4_Dmshws_6c_side1_low[i][j] = kmfit->pfit(i + tracks1.size() + showers1.size() + tracks2.size())[j];
                        if (m_sample_types[mm] == "side1_up") for (int j = 0; j < 4; j++) m_p4_Dmshws_6c_side1_up[i][j] = kmfit->pfit(i + tracks1.size() + showers1.size() + tracks2.size())[j];
                        if (m_sample_types[mm] == "side2_low") for (int j = 0; j < 4; j++) m_p4_Dmshws_6c_side2_low[i][j] = kmfit->pfit(i + tracks1.size() + showers1.size() + tracks2.size())[j];
                        if (m_sample_types[mm] == "side2_up") for (int j = 0; j < 4; j++) m_p4_Dmshws_6c_side2_up[i][j] = kmfit->pfit(i + tracks1.size() + showers1.size() + tracks2.size())[j];
                        if (m_sample_types[mm] == "side3_low") for (int j = 0; j < 4; j++) m_p4_Dmshws_6c_side3_low[i][j] = kmfit->pfit(i + tracks1.size() + showers1.size() + tracks2.size())[j];
                        if (m_sample_types[mm] == "side3_up") for (int j = 0; j < 4; j++) m_p4_Dmshws_6c_side3_up[i][j] = kmfit->pfit(i + tracks1.size() + showers1.size() + tracks2.size())[j];
                        if (m_sample_types[mm] == "side4_low") for (int j = 0; j < 4; j++) m_p4_Dmshws_6c_side4_low[i][j] = kmfit->pfit(i + tracks1.size() + showers1.size() + tracks2.size())[j];
                        if (m_sample_types[mm] == "side4_up") for (int j = 0; j < 4; j++) m_p4_Dmshws_6c_side4_up[i][j] = kmfit->pfit(i + tracks1.size() + showers1.size() + tracks2.size())[j];
                    }
                    HepLorentzVector kpipp4_6c = kmfit->pfit(tracks1.size() + showers1.size() + tracks2.size() + showers2.size());
                    if (m_sample_types[mm] == "signal") {
                        m_chisq_6c_signal = chisq_6c;
	                    m_p4_D0_6c_signal[0] = kD0p4_6c.px();
                        m_p4_D0_6c_signal[1] = kD0p4_6c.py();
                        m_p4_D0_6c_signal[2] = kD0p4_6c.pz();
                        m_p4_D0_6c_signal[3] = kD0p4_6c.e();
                        m_p4_Dm_6c_signal[0] = kDmp4_6c.px();
                        m_p4_Dm_6c_signal[1] = kDmp4_6c.py();
                        m_p4_Dm_6c_signal[2] = kDmp4_6c.pz();
                        m_p4_Dm_6c_signal[3] = kDmp4_6c.e();
                        m_p4_pip_6c_signal[0] = kpipp4_6c.px();
                        m_p4_pip_6c_signal[1] = kpipp4_6c.py();
                        m_p4_pip_6c_signal[2] = kpipp4_6c.pz();
                        m_p4_pip_6c_signal[3] = kpipp4_6c.e();
                        recordVariables(m_sample_types[mm]);
                        dtagTool.clear();
                    }
                    if (m_sample_types[mm] == "side1_low") {
                        m_chisq_6c_side1_low = chisq_6c;
	                    m_p4_D0_6c_side1_low[0] = kD0p4_6c.px();
                        m_p4_D0_6c_side1_low[1] = kD0p4_6c.py();
                        m_p4_D0_6c_side1_low[2] = kD0p4_6c.pz();
                        m_p4_D0_6c_side1_low[3] = kD0p4_6c.e();
                        m_p4_Dm_6c_side1_low[0] = kDmp4_6c.px();
                        m_p4_Dm_6c_side1_low[1] = kDmp4_6c.py();
                        m_p4_Dm_6c_side1_low[2] = kDmp4_6c.pz();
                        m_p4_Dm_6c_side1_low[3] = kDmp4_6c.e();
                        m_p4_pip_6c_side1_low[0] = kpipp4_6c.px();
                        m_p4_pip_6c_side1_low[1] = kpipp4_6c.py();
                        m_p4_pip_6c_side1_low[2] = kpipp4_6c.pz();
                        m_p4_pip_6c_side1_low[3] = kpipp4_6c.e();
                        recordVariables(m_sample_types[mm]);
                        dtagTool.clear();
                    }
                    if (m_sample_types[mm] == "side1_up") {
                        m_chisq_6c_side1_up = chisq_6c;
	                    m_p4_D0_6c_side1_up[0] = kD0p4_6c.px();
                        m_p4_D0_6c_side1_up[1] = kD0p4_6c.py();
                        m_p4_D0_6c_side1_up[2] = kD0p4_6c.pz();
                        m_p4_D0_6c_side1_up[3] = kD0p4_6c.e();
                        m_p4_Dm_6c_side1_up[0] = kDmp4_6c.px();
                        m_p4_Dm_6c_side1_up[1] = kDmp4_6c.py();
                        m_p4_Dm_6c_side1_up[2] = kDmp4_6c.pz();
                        m_p4_Dm_6c_side1_up[3] = kDmp4_6c.e();
                        m_p4_pip_6c_side1_up[0] = kpipp4_6c.px();
                        m_p4_pip_6c_side1_up[1] = kpipp4_6c.py();
                        m_p4_pip_6c_side1_up[2] = kpipp4_6c.pz();
                        m_p4_pip_6c_side1_up[3] = kpipp4_6c.e();
                        recordVariables(m_sample_types[mm]);
                        dtagTool.clear();
                    }
                    if (m_sample_types[mm] == "side2_low") {
                        m_chisq_6c_side2_low = chisq_6c;
	                    m_p4_D0_6c_side2_low[0] = kD0p4_6c.px();
                        m_p4_D0_6c_side2_low[1] = kD0p4_6c.py();
                        m_p4_D0_6c_side2_low[2] = kD0p4_6c.pz();
                        m_p4_D0_6c_side2_low[3] = kD0p4_6c.e();
                        m_p4_Dm_6c_side2_low[0] = kDmp4_6c.px();
                        m_p4_Dm_6c_side2_low[1] = kDmp4_6c.py();
                        m_p4_Dm_6c_side2_low[2] = kDmp4_6c.pz();
                        m_p4_Dm_6c_side2_low[3] = kDmp4_6c.e();
                        m_p4_pip_6c_side2_low[0] = kpipp4_6c.px();
                        m_p4_pip_6c_side2_low[1] = kpipp4_6c.py();
                        m_p4_pip_6c_side2_low[2] = kpipp4_6c.pz();
                        m_p4_pip_6c_side2_low[3] = kpipp4_6c.e();
                        recordVariables(m_sample_types[mm]);
                        dtagTool.clear();
                    }
                    if (m_sample_types[mm] == "side2_up") {
                        m_chisq_6c_side2_up = chisq_6c;
	                    m_p4_D0_6c_side2_up[0] = kD0p4_6c.px();
                        m_p4_D0_6c_side2_up[1] = kD0p4_6c.py();
                        m_p4_D0_6c_side2_up[2] = kD0p4_6c.pz();
                        m_p4_D0_6c_side2_up[3] = kD0p4_6c.e();
                        m_p4_Dm_6c_side2_up[0] = kDmp4_6c.px();
                        m_p4_Dm_6c_side2_up[1] = kDmp4_6c.py();
                        m_p4_Dm_6c_side2_up[2] = kDmp4_6c.pz();
                        m_p4_Dm_6c_side2_up[3] = kDmp4_6c.e();
                        m_p4_pip_6c_side2_up[0] = kpipp4_6c.px();
                        m_p4_pip_6c_side2_up[1] = kpipp4_6c.py();
                        m_p4_pip_6c_side2_up[2] = kpipp4_6c.pz();
                        m_p4_pip_6c_side2_up[3] = kpipp4_6c.e();
                        recordVariables(m_sample_types[mm]);
                        dtagTool.clear();
                    }
                    if (m_sample_types[mm] == "side3_low") {
                        m_chisq_6c_side3_low = chisq_6c;
	                    m_p4_D0_6c_side3_low[0] = kD0p4_6c.px();
                        m_p4_D0_6c_side3_low[1] = kD0p4_6c.py();
                        m_p4_D0_6c_side3_low[2] = kD0p4_6c.pz();
                        m_p4_D0_6c_side3_low[3] = kD0p4_6c.e();
                        m_p4_Dm_6c_side3_low[0] = kDmp4_6c.px();
                        m_p4_Dm_6c_side3_low[1] = kDmp4_6c.py();
                        m_p4_Dm_6c_side3_low[2] = kDmp4_6c.pz();
                        m_p4_Dm_6c_side3_low[3] = kDmp4_6c.e();
                        m_p4_pip_6c_side3_low[0] = kpipp4_6c.px();
                        m_p4_pip_6c_side3_low[1] = kpipp4_6c.py();
                        m_p4_pip_6c_side3_low[2] = kpipp4_6c.pz();
                        m_p4_pip_6c_side3_low[3] = kpipp4_6c.e();
                        recordVariables(m_sample_types[mm]);
                        dtagTool.clear();
                    }
                    if (m_sample_types[mm] == "side3_up") {
                        m_chisq_6c_side3_up = chisq_6c;
	                    m_p4_D0_6c_side3_up[0] = kD0p4_6c.px();
                        m_p4_D0_6c_side3_up[1] = kD0p4_6c.py();
                        m_p4_D0_6c_side3_up[2] = kD0p4_6c.pz();
                        m_p4_D0_6c_side3_up[3] = kD0p4_6c.e();
                        m_p4_Dm_6c_side3_up[0] = kDmp4_6c.px();
                        m_p4_Dm_6c_side3_up[1] = kDmp4_6c.py();
                        m_p4_Dm_6c_side3_up[2] = kDmp4_6c.pz();
                        m_p4_Dm_6c_side3_up[3] = kDmp4_6c.e();
                        m_p4_pip_6c_side3_up[0] = kpipp4_6c.px();
                        m_p4_pip_6c_side3_up[1] = kpipp4_6c.py();
                        m_p4_pip_6c_side3_up[2] = kpipp4_6c.pz();
                        m_p4_pip_6c_side3_up[3] = kpipp4_6c.e();
                        recordVariables(m_sample_types[mm]);
                        dtagTool.clear();
                    }
                    if (m_sample_types[mm] == "side4_low") {
                        m_chisq_6c_side4_low = chisq_6c;
	                    m_p4_D0_6c_side4_low[0] = kD0p4_6c.px();
                        m_p4_D0_6c_side4_low[1] = kD0p4_6c.py();
                        m_p4_D0_6c_side4_low[2] = kD0p4_6c.pz();
                        m_p4_D0_6c_side4_low[3] = kD0p4_6c.e();
                        m_p4_Dm_6c_side4_low[0] = kDmp4_6c.px();
                        m_p4_Dm_6c_side4_low[1] = kDmp4_6c.py();
                        m_p4_Dm_6c_side4_low[2] = kDmp4_6c.pz();
                        m_p4_Dm_6c_side4_low[3] = kDmp4_6c.e();
                        m_p4_pip_6c_side4_low[0] = kpipp4_6c.px();
                        m_p4_pip_6c_side4_low[1] = kpipp4_6c.py();
                        m_p4_pip_6c_side4_low[2] = kpipp4_6c.pz();
                        m_p4_pip_6c_side4_low[3] = kpipp4_6c.e();
                        recordVariables(m_sample_types[mm]);
                        dtagTool.clear();
                    }
                    if (m_sample_types[mm] == "side4_up") {
                        m_chisq_6c_side4_up = chisq_6c;
	                    m_p4_D0_6c_side4_up[0] = kD0p4_6c.px();
                        m_p4_D0_6c_side4_up[1] = kD0p4_6c.py();
                        m_p4_D0_6c_side4_up[2] = kD0p4_6c.pz();
                        m_p4_D0_6c_side4_up[3] = kD0p4_6c.e();
                        m_p4_Dm_6c_side4_up[0] = kDmp4_6c.px();
                        m_p4_Dm_6c_side4_up[1] = kDmp4_6c.py();
                        m_p4_Dm_6c_side4_up[2] = kDmp4_6c.pz();
                        m_p4_Dm_6c_side4_up[3] = kDmp4_6c.e();
                        m_p4_pip_6c_side4_up[0] = kpipp4_6c.px();
                        m_p4_pip_6c_side4_up[1] = kpipp4_6c.py();
                        m_p4_pip_6c_side4_up[2] = kpipp4_6c.pz();
                        m_p4_pip_6c_side4_up[3] = kpipp4_6c.e();
                        recordVariables(m_sample_types[mm]);
                        dtagTool.clear();
                    }
                } // ***** tag1
