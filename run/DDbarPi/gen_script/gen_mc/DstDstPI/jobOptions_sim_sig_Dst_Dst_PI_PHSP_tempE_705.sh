...
DIR_NAME="/besfs/groups/cal/dedx/$USER/bes/DDbarPi-DT/run/DDbarPi/rtraw/mc/DstDstPI/$ENERGYPOINT/"
mkdir -p $DIR_NAME

echo "./jobOptions_sim_sig_Dst_Dst_PI_PHSP_${ENERGYPOINT}.sh [NUM1] [NUM2] [NUM3]"
...
JOB_NAME="jobOptions_sim_sig_Dst_Dst_PI_PHSP"
FILE_NAME="Sig_Dst_Dst_PI_PHSP"
...
do
    ...
    echo "EvtDecay.userDecayTableName = \"/besfs/groups/cal/dedx/$USER/bes/DDbarPi-DT/run/DDbarPi/gen_script/gen_mc/decay/psi4260_Dst_Dst_PI_PHSP.dec\";" >> $SIM_NAME
