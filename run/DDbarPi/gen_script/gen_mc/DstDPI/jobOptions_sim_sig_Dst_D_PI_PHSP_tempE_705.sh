...
DIR_NAME="/besfs/groups/cal/dedx/$USER/bes/DDbarPi-DT/run/DDbarPi/rtraw/mc/DstDPI/$ENERGYPOINT/"
mkdir -p $DIR_NAME
...
do
    ...
    echo "EvtDecay.userDecayTableName = \"/besfs/groups/cal/dedx/$USER/bes/DDbarPi-DT/run/DDbarPi/gen_script/gen_mc/decay/psi4260_Dst_D_PI_PHSP.dec\";" >> $SIM_NAME
