...
DIR_NAME_RTRAW="/besfs/groups/cal/dedx/$USER/bes/DDbarPi-DT/run/DDbarPi/rtraw/mc/DstDPI/$ENERGYPOINT/"
DIR_NAME_DST="/besfs/groups/cal/dedx/$USER/bes/DDbarPi-DT/run/DDbarPi/dst/mc/DstDPI/$ENERGYPOINT/"
