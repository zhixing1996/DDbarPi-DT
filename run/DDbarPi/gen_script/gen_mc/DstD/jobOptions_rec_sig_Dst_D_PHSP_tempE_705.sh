...
echo "./jobOptions_rec_sig_Dst_D_PHSP_${ENERGYPOINT}.sh [NUM1] [NUM2]"
echo "[NUM1]: the minimum number range of job generated"
echo "[NUM2]: the maximum number range of job generated"

SEED=223
 
DIR_NAME_RTRAW="/besfs/groups/cal/dedx/$USER/bes/DDbarPi-DT/run/DDbarPi/rtraw/mc/DstD/$ENERGYPOINT/"
DIR_NAME_DST="/besfs/groups/cal/dedx/$USER/bes/DDbarPi-DT/run/DDbarPi/dst/mc/DstD/$ENERGYPOINT/"
mkdir -p $DIR_NAME_DST
EVENT_NO=-1

JOB_NAME="jobOptions_rec_sig_Dst_D_PHSP_$ENERGYPOINT"
INPUT_NAME="Sig_Dst_D_PHSP_$ENERGYPOINT"
OUTPUT_NAME="Sig_Dst_D_PHSP_$ENERGYPOINT"
