#!/usr/bin/env python
"""
Plot invariant mass of D0 and Dm in every tag mode
"""
...
def plot(path, leg_title, ecms, xmin, xmax, xbins):
    ...
    for Dm_k, Dm_v in Dm_dict.items():
        for D0_k, D0_v in D0_dict.items():
            ...
            N_DstD = m_D0Dm_fill(t_DstD, h_DstD, Dm_k, D0_k)
            ...
            N_DstDst = m_D0Dm_fill(t_DstDst, h_DstDst, Dm_k, D0_k)
            ...
            N_DDPI0 = m_D0Dm_fill(t_DDPI0, h_DDPI0, Dm_k, D0_k)
            ...
            N_DstDPI = m_D0Dm_fill(t_DstDPI, h_DstDPI, Dm_k, D0_k)
            ...
            N_DstDstPI = m_D0Dm_fill(t_DstDstPI, h_DstDstPI, Dm_k, D0_k)
            ...
            N_DDPIPI = m_D0Dm_fill(t_DDPIPI, h_DDPIPI, Dm_k, D0_k)
            ...
            N_DstDPIPI = m_D0Dm_fill(t_DstDPIPI, h_DstDPIPI, Dm_k, D0_k)
            ...
            ratio = round((N_DD + N_DstD + N_DstDst + N_DDPI0 + N_DstDPI + N_DstDstPI + N_DDPIPI + N_DstDPIPI + N_DstDstPIPI + N_qq*0.25)/float(N_data), 2)
            ...
            mbc.SaveAs('./figs/m_D0Dm_'+str(ecms)+'_'+str(Dm_k)+'_'+str(D0_k)+'.pdf')
