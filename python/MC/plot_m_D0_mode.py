#!/usr/bin/env python
"""
Plot invariant mass of D0 in every tag mode
"""
...
def m_D0_fill(t, h, Dm_k, D0_k):
    ...
    for ientry in xrange(t.GetEntries()):
        ...
        if t.m_Dm_mode == Dm_k and t.m_D0_mode == D0_k: 
            if not (t.m_Dm_mass > Dm_signal_low and t.m_Dm_mass < Dm_signal_up): continue
            h.Fill(t.m_D0_mass)
            count += 1
    return count
...
def plot(path, leg_title, ecms, xmin, xmax, xbins):
    ...
    for Dm_k, Dm_v in Dm_dict.items():
        for D0_k, D0_v in D0_dict.items():
            ...
            N_DstD = m_D0_fill(t_DstD, h_DstD, Dm_k, D0_k)
            ...
            N_DstDst = m_D0_fill(t_DstDst, h_DstDst, Dm_k, D0_k)
            ...
            N_DDPI0 = m_D0_fill(t_DDPI0, h_DDPI0, Dm_k, D0_k)
            ...
            N_DstDPI = m_D0_fill(t_DstDPI, h_DstDPI, Dm_k, D0_k)
            ...
            N_DstDstPI = m_D0_fill(t_DstDstPI, h_DstDstPI, Dm_k, D0_k)
            ...
            N_DDPIPI = m_D0_fill(t_DDPIPI, h_DDPIPI, Dm_k, D0_k)
            ...
            N_DstDPIPI = m_D0_fill(t_DstDPIPI, h_DstDPIPI, Dm_k, D0_k)
            ...
            mbc.SaveAs('./figs/m_D0_'+str(ecms)+'_'+str(Dm_k)+'_'+str(D0_k)+'.pdf')
