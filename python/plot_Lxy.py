#!/usr/bin/env python
"""
Plot Lxy of D0 and D- after second vertex fit
"""
...
def Lxy_fill(t, h):
    for ientry in xrange(t.GetEntries()):
        t.GetEntry(ientry)
        h.Fill(t.m_Lxy_svf_D0 + t.m_Lxy_svf_Dm)
...
def plot(path, leg_title, ecms, xmin, xmax, xbins):
    ...
    mbc.SaveAs('./figs/Lxy_'+str(ecms)+'.pdf')
